!function(e, t) {
    "object" == typeof exports && "undefined" != typeof module ? t(exports) : "function" == typeof define && define.amd ? define(["exports"], t) : t((e = "undefined" != typeof globalThis ? globalThis : e || self).GeoTIFF = {})
}(this, (function(e) {
    "use strict";
    function t(e, t, r) {
    ...
    function g(e, t, r) {
        return g = y() ? Reflect.construct : function(e, t, r) {
            var n = [null];
            n.push.apply(n, t);
    ...
    !function(e) {
        var t = function(e) {
            var t, r = Object.prototype, n = r.hasOwnProperty, i = "function" == typeof Symbol ? Symbol : {}, a = i.iterator || "@@iterator", o = i.asyncIterator || "@@asyncIterator", s = i.toStringTag || "@@toStringTag";
            function u(e, t, r) {
            ...
            var A = w.prototype = y.prototype = Object.create(b);
            function _(e) {
    ...
    for (var I = new ArrayBuffer(4), P = new Float32Array(I), S = new Uint32Array(I), T = new Uint32Array(512), U = new Uint32Array(512), O = 0; O < 256; ++O) {
        var D = O - 127;
        D < -27 ? (T[O] = 0,
        T[256 | O] = 32768,
        U[O] = 24,
        U[256 | O] = 24) : D < -14 ? (T[O] = 1024 >> -D - 14,
        T[256 | O] = 1024 >> -D - 14 | 32768,
        U[O] = -D - 1,
        U[256 | O] = -D - 1) : D <= 15 ? (T[O] = D + 15 << 10,
        T[256 | O] = D + 15 << 10 | 32768,
        U[O] = 13,
        U[256 | O] = 13) : D < 128 ? (T[O] = 31744,
        T[256 | O] = 64512,
        U[O] = 24,
        U[256 | O] = 24) : (T[O] = 31744,
        T[256 | O] = 64512,
        U[O] = 13,
        U[256 | O] = 13)
    }
    var E = new Uint32Array(2048)
      , R = new Uint32Array(64)
      , M = new Uint32Array(64);
    E[0] = 0;
    for (var B = 1; B < 1024; ++B) {
        for (var C = B << 13, L = 0; 0 == (8388608 & C); )
            L -= 8388608,
            C <<= 1;
        C &= -8388609,
        L += 947912704,
    ...
    for (var F = 1024; F < 2048; ++F)
        E[F] = 939524096 + (F - 1024 << 13);
    R[0] = 0;
    for (var V = 1; V < 31; ++V)
        R[V] = V << 23;
    R[31] = 1199570944,
    ...
    function z(e) {
        var t = e >> 10;
        return S[0] = E[M[t] + (1023 & e)] + R[t],
        P[0]
    }
    var N = Reflect.getPrototypeOf(Uint8Array).prototype
      , K = Reflect.getOwnPropertyDescriptor(N, Symbol.toStringTag).get;
    var Z = Object.prototype.toString;
    function H(e) {
        return !!ArrayBuffer.isView(e) && (!function(e) {
            return void 0 !== K.call(e)
    ...
    function Y(e, t) {
        ...
        for (var r = arguments.length, n = new Array(r > 2 ? r - 2 : 0), i = 2; i < r; i++)
            n[i - 2] = arguments[i];
        return z(e.getUint16.apply(e, [t].concat(n)))
    }
    ...
    var W = function(e, t, r) {
        ...
        var a = X(e, "<".concat(t, "[ >]"), i);
        if (n && console.log("start:", a),
        -1 !== a) {
            ...
            if (n && console.log("end:", f),
            -1 !== f) {
                var c = e.slice(a, f);
                return {
                    inner: u ? null : c.slice(c.indexOf(">") + 1, c.lastIndexOf("<")),
                    outer: c,
                    start: a,
                    end: f
                }
    ...
    var J = function(e, t, r) {
        for (var n, i = [], a = r && r.debug || !1, o = r && r.startIndex || 0; n = W(e, t, {
            debug: a,
            startIndex: o
        }); )
            o = n.end,
            i.push(n);
        return a && console.log("findTagsByName found", i.length, "tags"),
        i
    }
      , Q = {
        315: "Artist",
      ...
      , $ = {};
    for (var ee in Q)
        Q.hasOwnProperty(ee) && ($[Q[ee]] = parseInt(ee, 10));
    var te = {
        256: "SHORT",
        257: "SHORT",
        258: "SHORT",
      ...
      , re = [$.BitsPerSample, $.ExtraSamples, $.SampleFormat, $.StripByteCounts, $.StripOffsets, $.StripRowCounts, $.TileByteCounts, $.TileOffsets, $.SubIFDs]
      , ne = {
        1: "BYTE",
        2: "ASCII",
        3: "SHORT",
      ...
      , ie = {};
    for (var ae in ne)
        ne.hasOwnProperty(ae) && (ie[ne[ae]] = parseInt(ae, 10));
    var oe = {
        WhiteIsZero: 0,
        BlackIsZero: 1,
        RGB: 2,
      ...
      , le = {};
    for (var he in ce)
        ce.hasOwnProperty(he) && (le[ce[he]] = parseInt(he, 10));
    var de = Object.freeze({
        ...
        fieldTypeNames: ne,
        fieldTypes: ie,
        photometricInterpretations: oe,
        ExtraSamplesValues: se,
        LercParameters: ue,
        LercAddCompression: fe,
        geoKeyNames: ce,
        geoKeys: le
    });
    function pe(e, t) {
        for (var r, n = e.width, i = e.height, a = new Uint8Array(n * i * 3), o = 0, s = 0; o < e.length; ++o,
        s += 3)
            r = 256 - e[o] / t * 256,
            a[s] = r,
            a[s + 1] = r,
    ...
    function ve(e, t) {
        for (var r = e.width, n = e.height, i = new Uint8Array(r * n * 3), a = t.length / 3, o = t.length / 3 * 2, s = 0, u = 0; s < e.length; ++s,
        u += 3) {
            var f = e[s];
            i[u] = t[f] / 65536 * 256,
            i[u + 1] = t[f + a] / 65536 * 256,
            i[u + 2] = t[f + o] / 65536 * 256
        }
        return i
    }
    function ye(e) {
        for (var t = e.width, r = e.height, n = new Uint8Array(t * r * 3), i = 0, a = 0; i < e.length; i += 4,
        a += 3) {
            var o = e[i]
              , s = e[i + 1]
              , u = e[i + 2]
              , f = e[i + 3];
            n[a] = (255 - o) / 256 * 255 * ((255 - f) / 256),
            n[a + 1] = (255 - s) / 256 * 255 * ((255 - f) / 256),
            n[a + 2] = (255 - u) / 256 * 255 * ((255 - f) / 256)
        }
        return n
    }
    function ge(e) {
        for (var t = e.width, r = e.height, n = new Uint8ClampedArray(t * r * 3), i = 0, a = 0; i < e.length; i += 3,
        a += 3) {
            var o = e[i]
              , s = e[i + 1]
              , u = e[i + 2];
            n[a] = o + 1.402 * (u - 128),
            n[a + 1] = o - .34414 * (s - 128) - .71414 * (u - 128),
            n[a + 2] = o + 1.772 * (s - 128)
        }
        return n
    }
    function we(e) {
        for (var t = e.width, r = e.height, n = new Uint8Array(t * r * 3), i = 0, a = 0; i < e.length; i += 3,
        a += 3) {
            var o = (e[i + 0] + 16) / 116
              , s = (e[i + 1] << 24 >> 24) / 500 + o
              , u = o - (e[i + 2] << 24 >> 24) / 200
              ...
              , c = void 0
              , l = void 0;
            c = -.9689 * (s = .95047 * (s * s * s > .008856 ? s * s * s : (s - 16 / 116) / 7.787)) + 1.8758 * (o = 1 * (o * o * o > .008856 ? o * o * o : (o - 16 / 116) / 7.787)) + .0415 * (u = 1.08883 * (u * u * u > .008856 ? u * u * u : (u - 16 / 116) / 7.787)),
            l = .0557 * s + -.204 * o + 1.057 * u,
            f = (f = 3.2406 * s + -1.5372 * o + -.4986 * u) > .0031308 ? 1.055 * Math.pow(f, 1 / 2.4) - .055 : 12.92 * f,
            c = c > .0031308 ? 1.055 * Math.pow(c, 1 / 2.4) - .055 : 12.92 * c,
            l = l > .0031308 ? 1.055 * Math.pow(l, 1 / 2.4) - .055 : 12.92 * l,
            n[a] = 255 * Math.max(0, Math.min(1, f)),
            n[a + 1] = 255 * Math.max(0, Math.min(1, c)),
            n[a + 2] = 255 * Math.max(0, Math.min(1, l))
        }
        return n
    }
    ...
    function _e() {
        return (_e = u(x.mark((function e(t) {
            var r, n;
            return x.wrap((function(e) {
                for (; ; )
                    switch (e.prev = e.next) {
                    case 0:
                        if (r = ke.get(t.Compression)) {
                            e.next = 3;
                            break
                        }
    ...
    function Pe(e, t, r, n, i) {
        ...
        return e.map((function(e) {
            for (var s = Ie(e, n, i), u = 0; u < i; ++u)
                for (var f = Math.min(Math.round(o * u), r - 1), c = 0; c < n; ++c) {
                    var l = Math.min(Math.round(a * c), t - 1)
                      , h = e[f * t + l];
                    s[u * n + c] = h
                }
            return s
    ...
    function Te(e, t, r, n, i) {
        ...
        return e.map((function(e) {
            for (var s = Ie(e, n, i), u = 0; u < i; ++u)
                for (var f = o * u, c = Math.floor(f), l = Math.min(Math.ceil(f), r - 1), h = 0; h < n; ++h) {
                    var d = a * h
                      , p = d % 1
                      , m = Math.floor(d)
                      , v = Math.min(Math.ceil(d), t - 1)
                      , y = e[c * t + m]
                      , g = e[c * t + v]
                      , w = e[l * t + m]
                      , b = e[l * t + v]
                      , k = Se(Se(y, g, p), Se(w, b, p), f % 1);
                    s[u * n + h] = k
                }
            return s
        }
    ...
    function Oe(e, t, r, n, i, a) {
        for (var o = t / n, s = r / i, u = Ie(e, n, i, a), f = 0; f < i; ++f)
            for (var c = Math.min(Math.round(s * f), r - 1), l = 0; l < n; ++l)
                for (var h = Math.min(Math.round(o * l), t - 1), d = 0; d < a; ++d) {
                    var p = e[c * t * a + h * a + d];
                    u[f * n * a + l * a + d] = p
                }
        return u
    ...
    function De(e, t, r, n, i, a) {
        for (var o = t / n, s = r / i, u = Ie(e, n, i, a), f = 0; f < i; ++f)
            for (var c = s * f, l = Math.floor(c), h = Math.min(Math.ceil(c), r - 1), d = 0; d < n; ++d)
                for (var p = o * d, m = p % 1, v = Math.floor(p), y = Math.min(Math.ceil(p), t - 1), g = 0; g < a; ++g) {
                    var w = e[l * t * a + v * a + g]
                      , b = e[l * t * a + y * a + g]
                      , k = e[h * t * a + v * a + g]
                      , x = e[h * t * a + y * a + g]
                      , A = Se(Se(w, b, m), Se(k, x, m), c % 1);
                    u[f * n * a + d * a + g] = A
                }
        return u
    }
    function Ee(e, t, r, n, i, a) {
        ...
        case "nearest":
            return Oe(e, t, r, n, i, a);
        case "bilinear":
        case "linear":
            return De(e, t, r, n, i, a);
        default:
    ...
    function Ce(e, t, r, n, i, a, o) {
        var s = new DataView(e)
          , u = 2 === r ? 1 : n
          , f = Me(t, i, 2 === r ? o * a : o * a * n)
          , c = parseInt("1".repeat(i), 2);
        if (1 === t) {
            var l = a * (1 === r ? n * i : i);
            0 != (7 & l) && (l = l + 7 & -8);
            for (var h = 0; h < o; ++h)
                for (var d = h * l, p = 0; p < a; ++p)
                    for (var m = d + p * u * i, v = 0; v < u; ++v) {
                        var y = m + v * i
                          , g = (h * a + p) * u + v
                          , w = Math.floor(y / 8)
                          , b = y % 8;
                        if (b + i <= 8)
                            f[g] = s.getUint8(w) >> 8 - i - b & c;
                        else if (b + i <= 16)
                            f[g] = s.getUint16(w) >> 16 - i - b & c;
                        else if (b + i <= 24) {
                            var k = s.getUint16(w) << 8 | s.getUint8(w + 2);
                            f[g] = k >> 24 - i - b & c
                        } else
                            f[g] = s.getUint32(w) >> 32 - i - b & c
                    }
        }
        return f.buffer
    }
    xe([void 0, 1], (function() {
    ...
    var Le = function() {
        function e(t, r, n, i, a, o) {
            ...
            if (this.planarConfiguration = void 0 === s ? 1 : s,
        ...
        return c(e, [{
            ...
            value: function(e, t) {
                return Me(this.getSampleFormat(e), this.getBitsPerSample(e), t)
            }
        }, {
            key: "getTileOrStrip",
            value: (i = u(x.mark((function e(t, r, n, i, a) {
                var o, s, f, c, l, h, d, p, m = this;
                return x.wrap((function(e) {
                    for (; ; )
                        switch (e.prev = e.next) {
                        case 0:
                            ...
                            c = this.tiles,
                            1 === this.planarConfiguration ? f = r * o + t : 2 === this.planarConfiguration && (f = n * o * s + r * o + t),
                            this.isTiled ? (l = this.fileDirectory.TileOffsets[f],
                            h = this.fileDirectory.TileByteCounts[f]) : (l = this.fileDirectory.StripOffsets[f],
                            h = this.fileDirectory.StripByteCounts[f]),
                            e.next = 7,
                            this.source.fetch([{
                                offset: l,
                                length: h
                        ...
                        case 7:
                            return d = e.sent[0],
                            null !== c && c[f] ? p = c[f] : (p = u(x.mark((function e() {
                                var t, n, a;
                                return x.wrap((function(e) {
                                    for (; ; )
                                        switch (e.prev = e.next) {
                                        case 0:
                                            return e.next = 2,
                                            i.decode(m.fileDirectory, d);
                                        case 2:
                                            return t = e.sent,
                                            n = m.getSampleFormat(),
                                            a = m.getBitsPerSample(),
                                            Be(n, a) && (t = Ce(t, n, m.planarConfiguration, m.getSamplesPerPixel(), a, m.getTileWidth(), m.getBlockHeight(r))),
                                            e.abrupt("return", t);
                                        case 7:
                                        case "end":
                                            return e.stop()
            ...
            value: (n = u(x.mark((function e(t, r, n, i, a, o, s, u, f) {
                var c, l, h, d, p, m, v, y, g, w, b, k, A, _, I, P, S, T, U, O, D = this;
                return x.wrap((function(e) {
                    for (; ; )
                        switch (e.prev = e.next) {
                        case 0:
                            for (c = this.getTileWidth(),
                            l = this.getTileHeight(),
                            h = this.getWidth(),
                            d = this.getHeight(),
                            p = Math.max(Math.floor(t[0] / c), 0),
                            m = Math.min(Math.ceil(t[2] / c), Math.ceil(h / c)),
                            v = Math.max(Math.floor(t[1] / l), 0),
                            y = Math.min(Math.ceil(t[3] / l), Math.ceil(d / l)),
                            g = t[2] - t[0],
                            w = this.getBytesPerPixel(),
                            b = [],
                            k = [],
                            A = 0; A < r.length; ++A)
                                1 === this.planarConfiguration ? b.push(Re(this.fileDirectory.BitsPerSample, 0, r[A]) / 8) : b.push(0),
                                k.push(this.getReaderForSample(r[A]));
                            for (_ = [],
                            I = this.littleEndian,
                            P = v; P < y; ++P)
                                for (S = p; S < m; ++S)
                                    for (T = function(e) {
                                        ...
                                        var u = D.getTileOrStrip(S, P, s, a, f).then((function(e) {
                                            for (var a = e.data, s = new DataView(a), u = D.getBlockHeight(e.y), f = e.y * l, p = e.x * c, m = f + u, v = (e.x + 1) * c, y = k[o], x = Math.min(u, u - (m - t[3]), d - f), A = Math.min(c, c - (v - t[2]), h - p), _ = Math.max(0, t[1] - f); _ < x; ++_)
                                                for (var P = Math.max(0, t[0] - p); P < A; ++P) {
                                                    var S = (_ * c + P) * w
                                                      , T = y.call(s, S + b[o], I)
                                                      , U = void 0;
                                                    i ? (U = (_ + f - t[1]) * g * r.length + (P + p - t[0]) * r.length + o,
                                                    n[U] = T) : (U = (_ + f - t[1]) * g + P + p - t[0],
                                                    n[o][U] = T)
                                                }
                                        }
                                        ));
                        ...
                        case 18:
                            ...
                            return (O = i ? Ee(n, t[2] - t[0], t[3] - t[1], o, s, r.length, u) : Ue(n, t[2] - t[0], t[3] - t[1], o, s, u)).width = o,
                            O.height = s,
                            e.abrupt("return", O);
                        case 23:
                            return n.width = o || t[2] - t[0],
                            n.height = s || t[3] - t[1],
                            e.abrupt("return", n);
                        case 26:
                        case "end":
            ...
            value: (r = u(x.mark((function e() {
                var t, r, n, i, a, o, s, u, f, c, l, h, d, p, m, v, y, g, w, b, k, A, _, I, P, S, T = arguments;
                return x.wrap((function(e) {
                    for (; ; )
                        switch (e.prev = e.next) {
                        case 0:
                            if (t = T.length > 0 && void 0 !== T[0] ? T[0] : {},
                            r = t.window,
                            n = t.samples,
                            i = void 0 === n ? [] : n,
                            a = t.interleave,
                            ...
                            l = t.fillValue,
                            h = t.signal,
                            !((d = r || [0, 0, this.getWidth(), this.getHeight()])[0] > d[2] || d[1] > d[3])) {
                                e.next = 4;
                                break
                            }
                        ...
                        case 19:
                            if (a)
                                k = this.fileDirectory.SampleFormat ? Math.max.apply(null, this.fileDirectory.SampleFormat) : 1,
                                A = Math.max.apply(null, this.fileDirectory.BitsPerSample),
                                b = Me(k, A, v * i.length),
                                l && b.fill(l);
                            else
                                for (b = [],
                                _ = 0; _ < i.length; ++_)
                                    I = this.getArrayForSample(i[_], v),
                                    Array.isArray(l) && _ < l.length ? I.fill(l[_]) : l && !Array.isArray(l) && I.fill(l),
                                    b.push(I);
                            if (e.t0 = s,
                            e.t0) {
                                e.next = 25;
                            ...
                            return e.next = 24,
                            Ae(this.fileDirectory);
                        case 24:
                            e.t0 = e.sent;
                        case 25:
                            return P = e.t0,
                            e.next = 28,
                            this._readRaster(d, i, b, a, P, u, f, c, h);
                        case 28:
                            return S = e.sent,
                            e.abrupt("return", S);
                        case 30:
            ...
            value: (t = u(x.mark((function e() {
                var t, r, n, i, a, o, s, u, f, c, l, h, d, p, m, v, y, g, w, b = this, k = arguments;
                return x.wrap((function(e) {
                    for (; ; )
                        switch (e.prev = e.next) {
                        case 0:
                            if (t = k.length > 0 && void 0 !== k[0] ? k[0] : {},
                            r = t.window,
                            n = t.interleave,
                            i = void 0 === n || n,
                            a = t.pool,
                            ...
                            throw new Error("Invalid subsets");
                        case 4:
                            if ((p = this.fileDirectory.PhotometricInterpretation) !== oe.RGB) {
                                e.next = 9;
                                break
                            }
                            if (m = [0, 1, 2],
                            this.fileDirectory.ExtraSamples !== se.Unspecified && l)
                                for (m = [],
                                v = 0; v < this.fileDirectory.BitsPerSample.length; v += 1)
                                    m.push(v);
                        ...
                        case 9:
                            e.t0 = p,
                            e.next = e.t0 === oe.WhiteIsZero || e.t0 === oe.BlackIsZero || e.t0 === oe.Palette ? 12 : e.t0 === oe.CMYK ? 14 : e.t0 === oe.YCbCr || e.t0 === oe.CIELab ? 16 : 18;
                            break;
                        case 12:
                            return y = [0],
                            e.abrupt("break", 19);
                        ...
                        case 19:
                            ...
                            e.abrupt("return", this.readRasters(g).then((function(e) {
                                var t, r = Math.pow(2, b.fileDirectory.BitsPerSample[0]);
                                switch (p) {
                                case oe.WhiteIsZero:
                                    t = pe(e, r);
                                    break;
                                ...
                                if (!i) {
                                    for (var n = new Uint8Array(t.length / 3), a = new Uint8Array(t.length / 3), o = new Uint8Array(t.length / 3), s = 0, u = 0; s < t.length; s += 3,
                                    ++u)
                                        n[u] = t[s],
                                        a[u] = t[s + 1],
                                        o[u] = t[s + 2];
            ...
            value: function() {
                ...
                n = null === e ? n.filter((function(e) {
                    return void 0 === q(e, "sample")
                }
                )) : n.filter((function(t) {
                    return Number(q(t, "sample")) === e
                }
                ));
            ...
            value: function() {
                ...
                if (this.fileDirectory.ModelTransformation) {
                    var r = o(this.fileDirectory.ModelTransformation, 8)
                      , n = r[0]
                      , i = r[1];
                    r[2];
                    var a = r[3]
                    ...
                    r[6];
                    var f = r[7]
                      , c = [[0, 0], [0, e], [t, 0], [t, e]].map((function(e) {
                        var t = o(e, 2)
                          , r = t[0]
                          , c = t[1];
                        return [a + n * r + i * c, f + s * r + u * c]
                    }
                    ))
                      , l = c.map((function(e) {
                        return e[0]
                    ...
                    return [Math.min.apply(Math, _(l)), Math.min.apply(Math, _(h)), Math.max.apply(Math, _(l)), Math.max.apply(Math, _(h))]
                }
                var d = this.getOrigin()
                  , p = this.getResolution()
                  , m = d[0]
                  , v = d[1]
                  , y = m + p[0] * this.getWidth()
                  , g = v + p[1] * this.getHeight();
                return [Math.min(m, y), Math.min(v, g), Math.max(m, y), Math.max(v, g)]
            }
        }]),
        e
    }()
      ...
      , Ve = function() {
        ...
        return c(e, [{
            ...
            key: "getUint64",
            value: function(e, t) {
                var r, n = this.getUint32(e, t), i = this.getUint32(e + 4, t);
                if (t) {
                    if (r = n + Math.pow(2, 32) * i,
                    !Number.isSafeInteger(r))
                        throw new Error("".concat(r, " exceeds MAX_SAFE_INTEGER. ") + "Precision may be lost. Please report if you get this message to https://github.com/geotiffjs/geotiff.js/issues");
                    return r
                }
                if (r = Math.pow(2, 32) * n + i,
                !Number.isSafeInteger(r))
                    throw new Error("".concat(r, " exceeds MAX_SAFE_INTEGER. ") + "Precision may be lost. Please report if you get this message to https://github.com/geotiffjs/geotiff.js/issues");
                return r
            }
      ...
      , Ge = function() {
        ...
        return c(e, [{
            ...
            key: "readUint64",
            value: function(e) {
                var t, r = this.readUint32(e), n = this.readUint32(e + 4);
                if (this._littleEndian) {
                    if (t = r + Math.pow(2, 32) * n,
                    !Number.isSafeInteger(t))
                        throw new Error("".concat(t, " exceeds MAX_SAFE_INTEGER. ") + "Precision may be lost. Please report if you get this message to https://github.com/geotiffjs/geotiff.js/issues");
                    return t
                }
                if (t = Math.pow(2, 32) * r + n,
                !Number.isSafeInteger(t))
                    throw new Error("".concat(t, " exceeds MAX_SAFE_INTEGER. ") + "Precision may be lost. Please report if you get this message to https://github.com/geotiffjs/geotiff.js/issues");
                return t
            }
      ...
      , je = "undefined" != typeof navigator && navigator.hardwareConcurrency || 2
      , ze = function() {
        function e() {
            var t = this
              , r = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : je
            ...
            this.size = r,
            this.messageId = 0,
            r && (this._awaitingDecoder = n ? Promise.resolve(n) : new Promise((function(e) {
            ...
            value: (t = u(x.mark((function e(t, r) {
                ...
                return x.wrap((function(e) {
                    for (; ; )
                        ...
                        case 3:
                            return e.abrupt("return", 0 === this.size ? Ae(t).then((function(e) {
                                return e.decode(t, r)
                            }
                                ...
                                i.worker.addEventListener("message", (function t(r) {
                                    r.data.id === a && (i.idle = !0,
                                    e(r.data.decoded),
                                    i.worker.removeEventListener("message", t))
                                }
                                )),
    ...
    function We(e) {
        ...
        return {
            type: o[0],
            params: qe(o.slice(1).map((function(e) {
                return e.split("=")
            }
            )))
        }
    ...
    function Qe(e, t) {
        ...
        for (; r < e.byteLength; ) {
            ...
            var c = f.indexOf(Ye)
              , l = Xe(f.substr(0, c))
              , h = Je(l["content-range"])
              , d = h.start
              , p = h.end
              , m = h.total
              , v = r + a.length + c + Ye.length
              , y = parseInt(p, 10) + 1 - parseInt(d, 10);
            i.push({
                headers: l,
                data: e.slice(v, v + y),
                offset: d,
    ...
    var nt = function(e, t, r) {
        ...
        function i() {
            ...
            if ("number" == typeof t.maxAge && 0 === t.maxAge)
                throw new TypeError("`maxAge` must be a number greater than 0");
            return e.maxSize = t.maxSize,
            e.maxAge = t.maxAge || Number.POSITIVE_INFINITY,
            e.onEviction = t.onEviction,
            e.cache = new Map,
            e.oldCache = new Map,
            e._size = 0,
            e
        ...
        return c(i, [{
            ...
            value: function(e, t) {
                return "number" == typeof t.expiry && t.expiry <= Date.now() && ("function" == typeof this.onEviction && this.onEviction(e, t.value),
                this.delete(e))
            }
        }, {
            ...
            value: x.mark((function e() {
                var t, r, n, i, a, s, u, f, c, l, h, d;
                return x.wrap((function(e) {
                    for (; ; )
                        switch (e.prev = e.next) {
                        case 0:
                        ...
                        case 3:
                            ...
                            if (!1 !== this._deleteIfExpired(a, s)) {
                                e.next = 11;
                                break
                            }
                            return e.next = 11,
            ...
            value: function(e) {
                ...
                if (this.oldCache.has(e)) {
                    var r = this.oldCache.get(e);
                    if (!1 === this._deleteIfExpired(e, r))
                        return this._moveToRecent(e, r),
                        r.value
                }
            }
        }, {
            ...
            value: function(e, t) {
                var r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}
                  , n = r.maxAge
                  , i = void 0 === n ? this.maxAge : n
                  , a = "number" == typeof i && i !== Number.POSITIVE_INFINITY ? Date.now() + i : void 0;
            ...
            key: "has",
            value: function(e) {
                return this.cache.has(e) ? !this._deleteIfExpired(e, this.cache.get(e)) : !!this.oldCache.has(e) && !this._deleteIfExpired(e, this.oldCache.get(e))
            }
        }, {
            key: "peek",
            value: function(e) {
                return this.cache.has(e) ? this._peek(e, this.cache) : this.oldCache.has(e) ? this._peek(e, this.oldCache) : void 0
            }
        }, {
            key: "delete",
            value: function(e) {
            ...
            value: function(e) {
                if (!(e && e > 0))
                    throw new TypeError("`maxSize` must be a number greater than 0");
                var t = _(this._entriesAscending())
                  , r = t.length - e;
            ...
            key: t,
            value: x.mark((function() {
                var e, t, r, n, i, a, s, u, f, c, l, h;
                return x.wrap((function(d) {
                    for (; ; )
                        ...
                        case 23:
                            ...
                            if (!1 !== this._deleteIfExpired(l, h)) {
                                d.next = 31;
                                break
                            }
                            return d.next = 31,
                ...
                ), a, this, [[1, 14, 17, 20], [21, 35, 38, 41]])
            }
            ))
        }, {
            key: "entriesDescending",
            value: x.mark((function e() {
                var t, r, n, i, a, s, u, f, c, l, h;
                return x.wrap((function(e) {
                    for (; ; )
                        switch (e.prev = e.next) {
                        case 0:
            ...
            get: function() {
                ...
                var e, t = 0, r = et(this.oldCache.keys());
                try {
                    for (r.s(); !(e = r.n()).done; ) {
                        var n = e.value;
                        this.cache.has(n) || t++
            ...
            key: "forEach",
            value: function(e) {
                var t, r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this, n = et(this.entriesAscending());
                try {
                    for (n.s(); !(t = n.n()).done; ) {
                        var i = o(t.value, 2)
                          , a = i[0]
            ...
            key: r,
            get: function() {
                return JSON.stringify(_(this.entriesAscending()))
            }
        }]),
        i
    }(w(Map), Symbol.iterator, Symbol.toStringTag);
    function it(e) {
        var t = function() {
            if ("undefined" == typeof Reflect || !Reflect.construct)
                return !1;
    ...
    function ct() {
        return (ct = u(x.mark((function e(t) {
            return x.wrap((function(e) {
                for (; ; )
                    switch (e.prev = e.next) {
                    case 0:
    ...
    var ht = function(e) {
        ...
        function r(e) {
            ...
            return b(this, r),
            n = t.call(this, e),
            Error.captureStackTrace && Error.captureStackTrace(p(n), r),
            n.name = "AbortError",
            n
        }
        return r
      ...
      , dt = function(e) {
        ...
        function r(e, n) {
            var i;
            return b(this, r),
            (i = t.call(this, n)).errors = e,
            i.message = n,
            i.name = "AggregateError",
            i
        }
        return r
    }(w(Error));
    ...
    var yt = function() {
      ...
      , wt = function(e) {
        ...
        var t, r = vt(n);
        function n(e) {
            var t, i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, a = i.blockSize, o = void 0 === a ? 65536 : a, s = i.cacheSize, u = void 0 === s ? 100 : s;
            return b(this, n),
            (t = r.call(this)).source = e,
            t.blockSize = o,
            t.blockCache = new nt({
                maxSize: u,
                onEviction: function(e, r) {
                    t.evictedBlocks.set(e, r)
                }
            }),
            t.evictedBlocks = new Map,
            t.blockRequests = new Map,
            t.blockIdsToFetch = new Set,
            t.abortedBlockIds = new Set,
            t
        }
        return c(n, [{
            key: "fileSize",
            ...
            key: "fetch",
            value: (t = u(x.mark((function e(t, r) {
                var n, i, a, o, s, u, f, c, l, h, d, p, m, v, y, g, w, b, k, A, _, I, P, S, T, U, O = this;
                return x.wrap((function(e) {
                    for (; ; )
                        switch (e.prev = e.next) {
                        case 0:
                            ...
                            try {
                                for (o.s(); !(s = o.n()).done; )
                                    ...
                                    c = u.length,
                                    l = f + c,
                                    null !== (h = this.fileSize) && (l = Math.min(l, h)),
                                    d = Math.floor(f / this.blockSize) * this.blockSize,
                                    p = d; p < l; p += this.blockSize)
                                        m = Math.floor(p / this.blockSize),
                                        this.blockCache.has(m) || this.blockRequests.has(m) || (this.blockIdsToFetch.add(m),
                                        i.push(m)),
                                        this.blockRequests.has(m) && n.push(this.blockRequests.get(m)),
                                        a.push(m)
                            } catch (e) {
                                o.e(e)
                            } finally {
                            ...
                            ft();
                        case 8:
                            for (this.fetchBlocks(r),
                            v = [],
                            y = 0,
                            g = i; y < g.length; y++)
                                w = g[y],
                                this.blockRequests.has(w) && v.push(this.blockRequests.get(w));
                            return e.next = 13,
                        ...
                        case 15:
                            ...
                            (k = a.filter((function(e) {
                                return O.abortedBlockIds.has(e) || !O.blockCache.has(e)
                            }
                            ))).forEach((function(e) {
                                return O.blockIdsToFetch.add(e)
                            }
                            )),
                            !(k.length > 0 && r) || r.aborted) {
                                e.next = 41;
                                break
                            }
                        ...
                        case 23:
                            ...
                            if (I = _.value,
                            P = this.blockRequests.get(I)) {
                                e.next = 28;
                                break
                            }
                            throw new Error("Block ".concat(I, " is not in the block requests"));
                        case 28:
                            b.push(P);
                        case 29:
                            e.next = 23;
                        ...
                        case 41:
                            ...
                            throw new ht("Request was aborted");
                        case 43:
                            if (S = a.map((function(e) {
                                return O.blockCache.get(e) || O.evictedBlocks.get(e)
                            }
                            )),
                            ...
                            throw new dt(T,"Request failed");
                        case 47:
                            return U = new Map(lt(a, S)),
                            e.abrupt("return", this.readSliceData(t, U));
                        case 49:
                        case "end":
                            return e.stop()
                        }
            ...
            value: function(e) {
                ...
                this.blockIdsToFetch.size > 0 && function() {
                    for (var r = t.groupBlocks(t.blockIdsToFetch), n = t.source.fetch(r, e), i = function(i) {
                        var a, o = pt(r[i].blockIds);
                        try {
                            var s = function() {
                                var r = a.value;
                                t.blockRequests.set(r, u(x.mark((function a() {
                                    var o, s, u, f, c, l;
                                    return x.wrap((function(a) {
                                        for (; ; )
                                            ...
                                            case 3:
                                                ...
                                                s = r * t.blockSize,
                                                u = s - o.offset,
                                                f = Math.min(u + t.blockSize, o.data.byteLength),
                                                c = o.data.slice(u, f),
                                                l = new yt(s,c.byteLength,c,r),
                                                t.blockCache.set(r, l),
                                                t.abortedBlockIds.delete(r),
                                                a.next = 23;
                                                break;
                                            case 14:
                                                if (a.prev = 14,
                                                a.t1 = a.catch(0),
                                                "AbortError" !== a.t1.name) {
                                                    a.next = 22;
                                                    break
                                                }
                                                a.t1.signal = e,
                                                t.blockCache.delete(r),
                                                t.abortedBlockIds.add(r),
                                                a.next = 23;
                                                break;
                                            case 22:
                                                throw a.t1;
            ...
            value: function(e) {
                ...
                if (0 === t.length)
                    return [];
                var r, n = [], i = null, a = [], o = pt(t);
                try {
                    for (o.s(); !(r = o.n()).done; ) {
                        var s = r.value;
                        null === i || i + 1 === s ? (n.push(s),
                        i = s) : (a.push(new gt(n[0] * this.blockSize,n.length * this.blockSize,n)),
                        n = [s],
                        i = s)
                    }
                } catch (e) {
                ...
                return a.push(new gt(n[0] * this.blockSize,n.length * this.blockSize,n)),
                a
            }
        }, {
            key: "readSliceData",
            value: function(e, t) {
                ...
                return e.map((function(e) {
                    ...
                    null !== r.fileSize && (n = Math.min(r.fileSize, n));
                    for (var i = Math.floor(e.offset / r.blockSize), a = Math.floor(n / r.blockSize), o = new ArrayBuffer(e.length), s = new Uint8Array(o), u = i; u <= a; ++u) {
                        var f = t.get(u)
                          , c = f.offset - e.offset
                          , l = 0
                          , h = 0
                          , d = void 0;
                        c < 0 ? l = -c : c > 0 && (h = c),
                        d = f.top - n < 0 ? f.length - l : n - f.offset - l;
                        var p = new Uint8Array(f.data,l,d);
                        s.set(p, h)
                    }
                    return o
                }
    ...
    var At = function(e) {
      ...
      , _t = function(e) {
        ...
        function n(e, t) {
            var i;
            return b(this, n),
            (i = r.call(this, e)).credentials = t,
            i
        }
        return c(n, [{
            key: "request",
            value: (t = u(x.mark((function e() {
                var t, r, n, i, a, o = arguments;
                return x.wrap((function(e) {
                    for (; ; )
                        switch (e.prev = e.next) {
                        case 0:
        ...
        return c(n, [{
            ...
            value: function(e, t) {
                ...
                return new Promise((function(n, i) {
                    ...
                    a.onerror = i,
                    a.onabort = function() {
                        return i(new ht("Request aborted"))
                    }
                    ,
                    a.send(),
                    t && (t.aborted && a.abort(),
    ...
    var Et = function(e) {
      ...
      , Rt = function(e) {
        ...
        function n(e) {
            var t;
            return b(this, n),
            (t = r.call(this, e)).parsedUrl = Tt.parse(t.url),
            t.httpApi = (t.parsedUrl.protocol,
            Tt),
            t
        }
        return c(n, [{
            ...
            value: function(e, t) {
                var r = this;
                return new Promise((function(n, i) {
                    var a = r.httpApi.get(Ot(Ot({}, r.parsedUrl), {}, {
                        headers: e
                    }), (function(e) {
                    ...
                    a.on("error", i),
                    t && (t.aborted && a.destroy(new ht("Request aborted")),
                    t.addEventListener("abort", (function() {
                        return a.destroy(new ht("Request aborted"))
                    }
                    )))
                }
                ))
      ...
      , Mt = ["headers", "credentials", "maxRanges", "allowFullFile"]
      , Bt = ["headers", "maxRanges", "allowFullFile"]
      , Ct = ["headers", "maxRanges", "allowFullFile"]
      , Lt = ["forceXHR"];
    function Ft(e, t) {
        var r = Object.keys(e);
        if (Object.getOwnPropertySymbols) {
    ...
    var jt = function(e) {
        ...
        return c(a, [{
            ...
            value: (r = u(x.mark((function e(t, r) {
                var n, i, a, o, s, u, f, c, l, h, d, p, m, v = this;
                return x.wrap((function(e) {
                    for (; ; )
                        switch (e.prev = e.next) {
                        case 0:
                        ...
                        case 7:
                            ...
                            if (i = We(n.getHeader("content-type")),
                            a = i.type,
                            o = i.params,
                        ...
                        case 13:
                            ...
                            s = (0,
                            e.t0)(e.t1, e.t2),
                            this._fileSize = s[0].fileSize || null,
                            e.abrupt("return", s);
                        case 18:
                            return e.next = 20,
                            n.getData();
                        case 20:
                            if (u = e.sent,
                            f = Je(n.getHeader("content-range")),
                            c = f.start,
                            l = f.end,
                            h = f.total,
                            ...
                            return e.next = 27,
                            Promise.all(t.slice(1).map((function(e) {
                                return v.fetchSlice(e, r)
                            }
                            )));
                        case 27:
                            return p = e.sent,
                            e.abrupt("return", d.concat(p));
                        case 29:
            ...
            value: (t = u(x.mark((function e(t, r) {
                ...
                return x.wrap((function(e) {
                    for (; ; )
                        ...
                        case 11:
                            return o = e.sent,
                            s = Je(a.getHeader("content-range")),
                            u = s.total,
    ...
    function Ht(e) {
        var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}
          ...
          , n = void 0 !== r && r
          , i = Ke(t, Lt);
        return "function" != typeof fetch || n ? "undefined" != typeof XMLHttpRequest ? Kt(e, i) : Zt(e, i) : Nt(e, i)
    }
    function Yt(e) {
        var t = function() {
            if ("undefined" == typeof Reflect || !Reflect.construct)
    ...
    function tr() {
        ...
        return new Promise((function(e, r) {
            Tt.read.apply(Tt, t.concat([function(t, n, i) {
                t ? r(t) : e({
                    bytesRead: n,
                    buffer: i
                })
    ...
    var rr = function(e) {
        ...
        function i(e) {
            var t;
            return b(this, i),
            (t = n.call(this)).path = e,
            t.openRequest = function(e, t) {
                var r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : void 0;
                return new Promise((function(n, i) {
                    Tt.open(e, t, r, (function(e, t) {
                        e ? i(e) : n(t)
                    }
                    ))
                }
                ...
                return x.wrap((function(e) {
                    for (; ; )
                        ...
                        case 2:
                            return r = e.sent,
                            e.next = 5,
                            tr(r, Buffer.alloc(t.length), 0, t.length, t.offset);
                        case 5:
                            return n = e.sent,
                            i = n.buffer,
                            e.abrupt("return", i.buffer);
                        case 8:
                        case "end":
                            return e.stop()
                        }
    ...
    lr.fl64 = new Float64Array(lr.ui8.buffer),
    lr.writeDouble = function(e, t, r) {
        lr.fl64[0] = r,
        ut(8, (function(r) {
            e[t + r] = lr.ui8[7 - r]
        }
    ...
    var hr = function(e) {
        ...
        e.forEach((function(r, a) {
            var o = function(e, t, r, n) {
                ...
                var o, s = (i += 2) + 12 * a.length + 4, u = ir(a);
                try {
                    var f = function() {
                        var r = o.value
                          , a = null;
                        ...
                        var u = te[a]
                          , f = fr[u];
                        if (null == u || void 0 === u || void 0 === u)
                            throw new Error("unknown type of tag: ".concat(a));
                        var c = n[r];
                        if (void 0 === c)
                            throw new Error("failed to get value for key ".concat(r));
                        "ASCII" === u && "string" == typeof c && !1 === ot(c, "\0") && (c += "\0");
                        var l = c.length;
                        e.writeUshort(t, i, a),
                        i += 2,
                        e.writeUshort(t, i, f),
                        i += 2,
                        e.writeUint(t, i, l);
                        var h = [-1, 1, 1, 2, 4, 8, 0, 0, 0, 0, 0, 0, 8][f] * l
                          , d = i += 4;
                        h > 4 && (e.writeUint(t, i, s),
                        d = s),
                        "ASCII" === u ? e.writeASCII(t, d, c) : "SHORT" === u ? ut(l, (function(r) {
                            e.writeUshort(t, d + 2 * r, c[r])
                        }
                        )) : "LONG" === u ? ut(l, (function(r) {
                            e.writeUint(t, d + 4 * r, c[r])
                        }
                        )) : "RATIONAL" === u ? ut(l, (function(r) {
                            e.writeUint(t, d + 8 * r, Math.round(1e4 * c[r])),
                            e.writeUint(t, d + 8 * r + 4, 1e4)
                        }
                        )) : "DOUBLE" === u && ut(l, (function(r) {
                            e.writeDouble(t, d + 8 * r, c[r])
                        }
                        )),
                        h > 4 && (s += h += 1 & h),
                        i += 4
            ...
            i = o[1],
            a < e.length - 1 && n.writeUint(t, o[0], i)
        }
        )),
        t.slice)
      ...
      , dr = [["Compression", 1], ["PlanarConfiguration", 1], ["ExtraSamples", 0]];
    function pr(e, t) {
        var r, n, i, a;
        "number" == typeof e[0] ? (r = t.height || t.ImageLength,
        i = t.width || t.ImageWidth,
        n = e.length / (r * i),
        a = e) : (n = e.length,
        r = e[0].length,
        i = e[0][0].length,
        ...
        t.ImageWidth = i,
        delete t.width,
        t.BitsPerSample || (t.BitsPerSample = ut(n, (function() {
            return 8
        }
        ))),
        ...
        t.SamplesPerPixel || (t.SamplesPerPixel = [n]),
        t.StripByteCounts || (t.StripByteCounts = [n * r * i]),
        t.ModelPixelScale || (t.ModelPixelScale = [360 / i, 180 / r, 0]),
        t.SampleFormat || (t.SampleFormat = ut(n, (function() {
            return 1
        }
        ))),
        t.hasOwnProperty("GeographicTypeGeoKey") || t.hasOwnProperty("ProjectedCSTypeGeoKey") || (t.GeographicTypeGeoKey = 4326,
        t.ModelTiepoint = [0, 0, 0, -180, 90, 0],
        t.GeogCitationGeoKey = "WGS 84",
        t.GTModelTypeGeoKey = 2);
        ...
        if (!t.GeoAsciiParams) {
            ...
            o.forEach((function(e) {
                var r = Number(ur[e]);
                "ASCII" === te[r] && (s += "".concat(t[e].toString(), "\0"))
            }
            )),
        ...
        if (!t.GeoKeyDirectory) {
            ...
            o.forEach((function(e) {
                var r, n, i, a = Number(ur[e]);
                u.push(a),
                "SHORT" === te[a] ? (r = 1,
                n = 0,
                i = t[e]) : "GeogCitationGeoKey" === e ? (r = t.GeoAsciiParams.length,
                n = Number(ur.GeoAsciiParams),
                i = 0) : console.log("[geotiff.js] couldn't get TIFFTagLocation for ".concat(e)),
                u.push(n),
                u.push(r),
                u.push(i)
            }
        ...
        var c = function(e) {
            var t = {};
            for (var r in e)
                "StripOffsets" !== r && (ur[r] || console.error(r, "not in name2code:", Object.keys(ur)),
                t[ur[r]] = e[r]);
            return t
        }(t)
          , l = function(e, t, r, n) {
            if (null == r)
                throw new Error("you passed into encodeImage a width of type ".concat(r));
            if (null == t)
            ...
            var o = new Uint8Array(hr([i]))
              , s = new Uint8Array(e)
              , u = i[277]
              , f = new Uint8Array(cr + t * r * u);
            return ut(o.length, (function(e) {
                f[e] = o[e]
            }
            )),
            function(e, t) {
    ...
    function gr(e, t, r, n, i, a) {
        ...
        for (var s = i[0] / 8, u = 2 === a ? 1 : i.length, f = 0; f < n && !(f * u * r * s >= e.byteLength); ++f) {
            ...
            if (2 === t) {
                switch (i[0]) {
                case 8:
                    c = new Uint8Array(e,f * u * r * s,u * r * s);
                    break;
                case 16:
                    c = new Uint16Array(e,f * u * r * s,u * r * s / 2);
                    break;
                case 32:
                    c = new Uint32Array(e,f * u * r * s,u * r * s / 4);
                    break;
                default:
                ...
                3 === t && yr(c = new Uint8Array(e,f * u * r * s,u * r * s), u, s)
        }
        return e
    }
    new mr;
                ...
                return x.wrap((function(e) {
                    for (; ; )
                        ...
                        case 2:
                            ...
                            return a = !t.StripOffsets,
                            o = a ? t.TileWidth : t.ImageWidth,
                            s = a ? t.TileLength : t.RowsPerStrip || t.ImageLength,
    ...
    function kr(e) {
        for (var r = 1; r < arguments.length; r++) {
            var n = null != arguments[r] ? arguments[r] : {};
            r % 2 ? br(Object(n), !0).forEach((function(r) {
                t(e, r, n[r])
            }
    ...
    function _r(e) {
        ...
        for (var r = {}, n = 4; n <= 4 * t[3]; n += 4) {
            ...
            if (a) {
                ...
                "string" == typeof u ? u = u.substring(s, s + o - 1) : u.subarray && (u = u.subarray(s, s + o),
                1 === o && (u = u[0]))
            } else
                u = s;
            r[i] = u
    ...
    function Ir(e, t, r, n) {
        ...
        case ie.SLONG8:
            ...
            break;
        case ie.RATIONAL:
            i = new Uint32Array(2 * r),
            a = e.readUint32;
            break;
        case ie.SRATIONAL:
            i = new Int32Array(2 * r),
            a = e.readInt32;
            break;
        case ie.FLOAT:
        ...
        if (t !== ie.RATIONAL && t !== ie.SRATIONAL)
            for (var s = 0; s < r; ++s)
                i[s] = a.call(e, n + s * o);
        else
            for (var u = 0; u < r; u += 2)
                i[u] = a.call(e, n + u * o),
                i[u + 1] = a.call(e, n + (u * o + 4));
        return t === ie.ASCII ? new TextDecoder("utf-8").decode(i) : i
    }
    var Pr = function e(t, r, n) {
      ...
      , Sr = function(e) {
        ...
        function r(e) {
            var n;
            return b(this, r),
            (n = t.call(this, "No image at index ".concat(e))).index = e,
            n
        }
        return r
    }(w(Error))
      , Tr = function() {
        ...
        return c(e, [{
            key: "readRasters",
            value: (t = u(x.mark((function e() {
                var t, r, n, i, a, s, u, f, c, l, h, d, p, m, v, y, g, w, b, k, A, _, I, P, S, T, U, O, D, E, R, M, B, C, L, F, V, G, j, z = arguments;
                return x.wrap((function(e) {
                    for (; ; )
                        switch (e.prev = e.next) {
                        case 0:
                            return t = z.length > 0 && void 0 !== z[0] ? z[0] : {},
                            r = t.window,
                            n = t.width,
                            i = t.height,
                            a = t.resX,
                        ...
                        case 13:
                            ...
                            w = g[0],
                            b = g[1],
                            u = [m + r[0] * w, v + r[1] * b, m + r[2] * w, v + r[3] * b]),
                            k = u || h,
                            !n) {
                                e.next = 20;
                                break
                        ...
                        case 38:
                            ...
                            if (O = A[U],
                            D = (h[2] - h[0]) / O.getWidth(),
                            E = (h[3] - h[1]) / O.getHeight(),
                            c = O,
                            !(a && a > D || s && s > E)) {
                                e.next = 45;
                                break
                        ...
                        case 48:
                            ...
                            G = V[0],
                            j = V[1],
                            R = [Math.round((u[0] - C) / G), Math.round((u[1] - L) / j), Math.round((u[2] - C) / G), Math.round((u[3] - L) / j)],
                            R = [Math.min(R[0], R[2]), Math.min(R[1], R[3]), Math.max(R[0], R[2]), Math.max(R[1], R[3])]),
                            e.abrupt("return", c.readRasters(kr(kr({}, t), {}, {
                                window: R
                            })));
                        case 51:
                        case "end":
      ...
      , Ur = function(e) {
        h(d, e);
        var t, r, n, i, a, s, f, l = xr(d);
        function d(e, t, r, n) {
            var i, a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : {};
            return b(this, d),
            (i = l.call(this)).source = e,
            i.littleEndian = t,
            i.bigTiff = r,
            i.firstIFDOffset = n,
            i.cache = a.cache || !1,
        ...
        return c(d, [{
            ...
            value: (f = u(x.mark((function e(t, r) {
                ...
                return x.wrap((function(e) {
                    for (; ; )
                        switch (e.prev = e.next) {
                        case 0:
                            return n = this.bigTiff ? 4048 : 1024,
                            e.t0 = Ge,
                            e.next = 4,
                            this.source.fetch([{
                                offset: t,
            ...
            value: (s = u(x.mark((function e(t) {
                var r, n, i, a, o, s, u, f, c, l, h, d, p, m, v, y, g, w, b, k;
                return x.wrap((function(e) {
                    for (; ; )
                        switch (e.prev = e.next) {
                        case 0:
                            return r = this.bigTiff ? 20 : 12,
                            n = this.bigTiff ? 8 : 2,
                            e.next = 4,
                            this.getSlice(t);
                        case 4:
                            if (i = e.sent,
                            a = this.bigTiff ? i.readUint64(t) : i.readUint16(t),
                            o = a * r + (this.bigTiff ? 16 : 6),
                            i.covers(t, o)) {
                                e.next = 11;
                                break
                            }
                        ...
                        case 14:
                            ...
                            if (c = i.readUint16(u),
                            l = i.readUint16(u + 2),
                            h = this.bigTiff ? i.readUint64(u + 4) : i.readUint32(u + 4),
                            d = void 0,
                            p = void 0,
                            m = Ar(l),
                            v = u + (this.bigTiff ? 12 : 8),
                            !(m * h <= (this.bigTiff ? 8 : 4))) {
                                e.next = 26;
                                break
                            }
                            d = Ir(i, l, h, v),
                        ...
                        case 34:
                            ...
                            d = Ir(w, l, h, y);
                        case 36:
                            p = 1 === h && -1 === re.indexOf(c) && l !== ie.RATIONAL && l !== ie.SRATIONAL ? d[0] : d,
                            s[Q[c]] = p;
                        case 38:
                            u += r,
                            ++f,
                        ...
                        case 41:
                            return b = _r(s),
                            k = i.readOffset(t + n + r * a),
                            e.abrupt("return", new Pr(s,b,k));
                        case 44:
                        case "end":
                            return e.stop()
                        }
            ...
            value: (i = u(x.mark((function e() {
                ...
                return x.wrap((function(e) {
                    for (; ; )
                        ...
                        case 3:
                            return r = e.sent,
                            e.abrupt("return", new Fe(r.fileDirectory,r.geoKeyDirectory,this.dataView,this.littleEndian,this.cache,this.source));
                        case 5:
                        case "end":
                            return e.stop()
                        }
            ...
            key: "getGhostValues",
            value: (r = u(x.mark((function e() {
                var t, r, n, i, a, s, u, f, c = this;
                return x.wrap((function(e) {
                    for (; ; )
                        switch (e.prev = e.next) {
                        case 0:
                            if (t = this.bigTiff ? 16 : 8,
                            !this.ghostValues) {
                                e.next = 3;
                                break
                            }
                        ...
                        case 3:
                            return n = (r = "GDAL_STRUCTURAL_METADATA_SIZE=").length + 100,
                            e.next = 7,
                            this.getSlice(t, n);
                        case 7:
                            if (i = e.sent,
                            r !== Ir(i, ie.ASCII, r.length, t)) {
                                e.next = 19;
                                break
                            }
                            if (a = Ir(i, ie.ASCII, n, t),
                            s = a.split("\n")[0],
                            !((u = Number(s.split("=")[1].split(" ")[0]) + s.length) > n)) {
                                e.next = 16;
                                break
                            }
                            return e.next = 15,
            ...
            value: (t = u(x.mark((function e(t, r, n) {
                ...
                return x.wrap((function(e) {
                    for (; ; )
                        ...
                        case 27:
                            return c = f ? a.getUint64(8, s) : a.getUint32(4, s),
                            e.abrupt("return", new d(t,s,f,c,r));
                        case 29:
                        case "end":
                            return e.stop()
                        }
      ...
      , Or = function(e) {
        ...
        function a(e, t) {
            var r;
            return b(this, a),
            (r = i.call(this)).mainFile = e,
            r.overviewFiles = t,
            r.imageFiles = [e].concat(t),
            r.fileDirectoriesPerFile = null,
            r.fileDirectoriesPerFileParsing = null,
            r.imageCount = null,
            r
        }
        return c(a, [{
                ...
                return x.wrap((function(e) {
                    for (; ; )
                        ...
                        case 0:
                            ...
                            Promise.all(t);
                        case 3:
                            return this.fileDirectoriesPerFile = e.sent,
            ...
            key: "getImage",
            value: (r = u(x.mark((function e() {
                var t, r, n, i, a, o, s, u = arguments;
                return x.wrap((function(e) {
                    for (; ; )
                        switch (e.prev = e.next) {
                        case 0:
                            return t = u.length > 0 && void 0 !== u[0] ? u[0] : 0,
                            e.next = 3,
                            this.getImageCount();
                        case 3:
                            return e.next = 5,
                            this.parseFileDirectoriesPerFile();
                        case 5:
                            r = 0,
                            n = 0,
                            i = 0;
                        ...
                        case 15:
                            return s = e.sent,
                            e.abrupt("return", new Fe(s.fileDirectory,s.geoKeyDirectory,a.dataView,a.littleEndian,a.cache,a.source));
                        case 17:
                            r++,
                            n++;
                        case 19:
                ...
                return x.wrap((function(e) {
                    for (; ; )
                        ...
                        case 2:
                            ...
                            Promise.all(t);
                        case 5:
                            return this.imageCounts = e.sent,
    ...
    function Dr() {
        return Dr = u(x.mark((function e(t) {
            var r, n, i = arguments;
            return x.wrap((function(e) {
                for (; ; )
                    switch (e.prev = e.next) {
                    case 0:
                        ...
                        e.abrupt("return", Ur.fromSource(Ht(t, r), n));
                    case 3:
                    case "end":
                        return e.stop()
                    }
    ...
    function Er() {
        return (Er = u(x.mark((function e(t, r) {
            return x.wrap((function(e) {
                for (; ; )
                    switch (e.prev = e.next) {
                    case 0:
                        return e.abrupt("return", Ur.fromSource(Xt(t), r));
                    case 1:
                    case "end":
                        return e.stop()
                    }
    ...
    function Rr() {
        return (Rr = u(x.mark((function e(t, r) {
            return x.wrap((function(e) {
                for (; ; )
                    switch (e.prev = e.next) {
                    case 0:
                        return e.abrupt("return", Ur.fromSource(nr(t), r));
                    case 1:
                    case "end":
                        return e.stop()
                    }
    ...
    function Mr() {
        return (Mr = u(x.mark((function e(t, r) {
            return x.wrap((function(e) {
                for (; ; )
                    switch (e.prev = e.next) {
                    case 0:
                        return e.abrupt("return", Ur.fromSource(Qt(t), r));
                    case 1:
                    case "end":
                        return e.stop()
                    }
    ...
    function Br() {
        return Br = u(x.mark((function e(t) {
            var r, n, i, a, o, s = arguments;
            return x.wrap((function(e) {
                for (; ; )
                    switch (e.prev = e.next) {
                    case 0:
                        ...
                        e.next = 5,
                        Ur.fromSource(Ht(t, n), i);
                    case 5:
                        return a = e.sent,
                        e.next = 8,
                        Promise.all(r.map((function(e) {
                            return Ur.fromSource(Ht(e, n))
                        }
                        )));
                    case 8:
                        return o = e.sent,
                        e.abrupt("return", new Or(a,o));
                    case 10:
                    case "end":
                        return e.stop()
                    }
        ...
        for (var h, d = new Uint8Array(e), p = u(d); 257 !== p; ) {
            if (256 === p) {
                ...
                if (257 === p)
                    break;
                if (p > 256)
                    throw new Error("corrupted code at scanline ".concat(p));
                Gr(l, c(p)),
                h = p
            } else if (p < i) {
                var m = c(p);
                ...
                var v = c(h);
                if (!v)
                    throw new Error("Bogus entry. Not in dictionary, ".concat(h, " / ").concat(i, ", position: ").concat(o));
                Gr(l, v),
                l.push(v[v.length - 1]),
                f(h, v[v.length - 1]),
                h = p
            }
            i + 1 >= Math.pow(2, a) && (12 === a ? h = void 0 : a++),
            p = u(d)
        }
    ...
    var Zr = new Int32Array([0, 1, 8, 16, 9, 2, 3, 10, 17, 24, 32, 25, 18, 11, 4, 5, 12, 19, 26, 33, 40, 48, 41, 34, 27, 20, 13, 6, 7, 14, 21, 28, 35, 42, 49, 56, 57, 50, 43, 36, 29, 22, 15, 23, 30, 37, 44, 51, 58, 59, 52, 45, 38, 31, 39, 46, 53, 60, 61, 54, 47, 55, 62, 63])
      , Hr = 4017
      , Yr = 799
      , qr = 3406
      , Xr = 2276
    ...
    function tn(e, t, r, n, i, a, o, s, u) {
        ...
        function v() {
            ...
            if (255 === (p = e[h++])) {
                var t = e[h++];
                if (t)
                    throw new Error("unexpected marker: ".concat((p << 8 | t).toString(16)))
            }
            return m = 7,
            p >>> 7
        }
        ...
        var I, P, S, T, U, O, D = n.length;
        O = c ? 0 === a ? 0 === s ? function(e, t) {
            var r = y(e.huffmanTableDC)
              , n = 0 === r ? 0 : w(r) << u;
            e.pred += n,
            t[0] = e.pred
        }
        ...
        : function(e, t) {
            for (var r = a, n = o, i = 0; r <= n; ) {
                ...
                case 1:
                case 2:
                    t[s] ? t[s] += (v() << u) * f : 0 == --i && (x = 2 === x ? 3 : 0);
                    break;
                case 3:
                    t[s] ? t[s] += (v() << u) * f : (t[s] = k << u,
                    x = 0);
                    break;
                case 4:
                    t[s] && (t[s] += (v() << u) * f)
    ...
    function rn(e, t) {
        var r = []
          ...
          , s = new Uint8Array(64);
        function u(e, r, n) {
            var i, a, o, s, u, f, c, l, h, d, p = t.quantizationTable, m = n;
            for (d = 0; d < 64; d++)
                m[d] = e[d] * p[d];
            for (d = 0; d < 8; ++d) {
                var v = 8 * d;
                0 !== m[1 + v] || 0 !== m[2 + v] || 0 !== m[3 + v] || 0 !== m[4 + v] || 0 !== m[5 + v] || 0 !== m[6 + v] || 0 !== m[7 + v] ? (i = Qr * m[0 + v] + 128 >> 8,
                a = Qr * m[4 + v] + 128 >> 8,
                o = m[2 + v],
                s = m[6 + v],
                u = $r * (m[1 + v] - m[7 + v]) + 128 >> 8,
                l = $r * (m[1 + v] + m[7 + v]) + 128 >> 8,
                f = m[3 + v] << 4,
                c = m[5 + v] << 4,
                h = i - a + 1 >> 1,
                i = i + a + 1 >> 1,
            ...
            for (d = 0; d < 8; ++d) {
                var y = d;
                0 !== m[8 + y] || 0 !== m[16 + y] || 0 !== m[24 + y] || 0 !== m[32 + y] || 0 !== m[40 + y] || 0 !== m[48 + y] || 0 !== m[56 + y] ? (i = Qr * m[0 + y] + 2048 >> 12,
                a = Qr * m[32 + y] + 2048 >> 12,
                o = m[16 + y],
                s = m[48 + y],
                u = $r * (m[8 + y] - m[56 + y]) + 2048 >> 12,
                l = $r * (m[8 + y] + m[56 + y]) + 2048 >> 12,
                f = m[24 + y],
                c = m[40 + y],
                h = i - a + 1 >> 1,
                i = i + a + 1 >> 1,
            ...
            for (d = 0; d < 64; ++d) {
                var g = 128 + (m[d] + 8 >> 4);
                r[d] = g < 0 ? 0 : g > 255 ? 255 : g
            }
        }
        for (var f = 0; f < i; f++) {
            for (var c = f << 3, l = 0; l < 8; l++)
                r.push(new Uint8Array(a));
            for (var h = 0; h < n; h++) {
                u(t.blocks[f][h], s, o);
                for (var d = 0, p = h << 3, m = 0; m < 8; m++)
                    for (var v = r[c + m], y = 0; y < 8; y++)
                        v[p + y] = s[d++]
            }
        }
        return r
    ...
    var nn = function() {
            ...
            value: function(e) {
                ...
                function n(e) {
                    ...
                    for (r in e.components)
                        e.components.hasOwnProperty(r) && (n < (t = e.components[r]).h && (n = t.h),
                        i < t.v && (i = t.v));
                    ...
                    for (r in e.components)
                        if (e.components.hasOwnProperty(r)) {
                            t = e.components[r];
                            for (var s = Math.ceil(Math.ceil(e.samplesPerLine / 8) * t.h / n), u = Math.ceil(Math.ceil(e.scanLines / 8) * t.v / i), f = a * t.h, c = o * t.v, l = [], h = 0; h < c; h++) {
                                for (var d = [], p = 0; p < f; p++)
                ...
                for (o = r(); 65497 !== o; ) {
                    ...
                    case 65499:
                        for (var u = r() + t - 2; t < u; ) {
                            ...
                            this.quantizationTables[15 & f] = c
                        }
                        break;
                    case 65472:
                    case 65473:
                    case 65474:
                        ...
                        for (var d = {
                            ...
                            components: {},
                            componentsOrder: []
                        }, p = e[t++], m = void 0, v = 0; v < p; v++) {
                            m = e[t];
                            var y = e[t + 1] >> 4
                              , g = 15 & e[t + 1]
                              , w = e[t + 2];
                            d.componentsOrder.push(m),
                            d.components[m] = {
                                h: y,
                                v: g,
                                quantizationIdx: w
                    ...
                    case 65476:
                        for (var b = r(), k = 2; k < b; ) {
                            for (var x = e[t++], A = new Uint8Array(16), _ = 0, I = 0; I < 16; I++,
                            t++)
                                A[I] = e[t],
                                _ += A[I];
                            for (var P = new Uint8Array(_), S = 0; S < _; S++,
                            t++)
                                P[S] = e[t];
                            k += 17 + _,
                            x >> 4 == 0 ? this.huffmanTablesDC[15 & x] = en(A, P) : this.huffmanTablesAC[15 & x] = en(A, P)
                        }
                        break;
                    case 65501:
                        r(),
                    ...
                    case 65498:
                        ...
                        for (var T = e[t++], U = [], O = this.frames[0], D = 0; D < T; D++) {
                            var E = O.components[e[t++]]
                              , R = e[t++];
                            E.huffmanTableDC = this.huffmanTablesDC[R >> 4],
                            E.huffmanTableAC = this.huffmanTablesAC[15 & R],
                            U.push(E)
                        }
                        var M = e[t++]
                          , B = e[t++]
                          , C = e[t++]
                          , L = tn(e, t, O, U, this.resetInterval, M, B, C >> 4, 15 & C);
                        t += L;
                        break;
                    case 65535:
                        255 !== e[t] && t--;
            ...
            value: function() {
                ...
                for (var t = 0; t < this.frames.length; t++)
                    for (var r = this.frames[t].components, n = 0, i = Object.keys(r); n < i.length; n++) {
                        var a = i[n];
                        r[a].quantizationTable = this.quantizationTables[r[a].quantizationIdx],
                        delete r[a].quantizationIdx
                    }
                for (var o = e[0], s = o.components, u = o.componentsOrder, f = [], c = o.samplesPerLine, l = o.scanLines, h = 0; h < u.length; h++) {
                    var d = s[u[h]];
                    f.push({
                        lines: rn(0, d),
                        scaleX: d.h / o.maxH,
                ...
                for (var p = new Uint8Array(c * l * f.length), m = 0, v = 0; v < l; ++v)
                    for (var y = 0; y < c; ++y)
                        for (var g = 0; g < f.length; ++g) {
                            var w = f[g];
                            p[m] = w.lines[0 | v * w.scaleY][0 | y * w.scaleX],
                            ++m
                        }
                return p
            }
      ...
      , an = function(e) {
        ...
        return c(r, [{
            key: "decodeBlock",
            value: function(e) {
                return this.reader.resetFrames(),
                this.reader.parse(new Uint8Array(e)),
    ...
    for (var yn = new Uint8Array(256), gn = 0; gn < 256; gn++)
        yn[gn] = gn >= 252 ? 6 : gn >= 248 ? 5 : gn >= 240 ? 4 : gn >= 224 ? 3 : gn >= 192 ? 2 : 1;
    yn[254] = yn[254] = 1;
    var wn = function(e) {
            ...
            if (o < 128)
                ...
                if (s > 4)
                    ...
                    for (o &= 2 === s ? 31 : 3 === s ? 15 : 7; s > 1 && r < i; )
                        o = o << 6 | 63 & e[r++],
                        s--;
                    s > 1 ? a[n++] = 65533 : o < 65536 ? a[n++] = o : (o -= 65536,
                    a[n++] = 55296 | o >> 10 & 1023,
                    a[n++] = 56320 | 1023 & o)
                }
            }
      ...
      , kn = function(e, t) {
        ...
        for (var r = t - 1; r >= 0 && 128 == (192 & e[r]); )
            r--;
        return r < 0 || 0 === r ? t : r + yn[e[r]] > t ? r : t
    };
    var xn = function() {
        this.input = null,
        this.next_in = 0,
      ...
      , An = function(e, t) {
        var r, n, i, a, o, s, u, f, c, l, h, d, p, m, v, y, g, w, b, k, x, A, _, I, P = e.state;
        r = e.next_in,
        _ = e.input,
        n = r + (e.avail_in - 5),
        i = e.next_out,
      ...
      , _n = 15
      , In = new Uint16Array([3, 4, 5, 6, 7, 8, 9, 10, 11, 13, 15, 17, 19, 23, 27, 31, 35, 43, 51, 59, 67, 83, 99, 115, 131, 163, 195, 227, 258, 0, 0])
      , Pn = new Uint8Array([16, 16, 16, 16, 16, 16, 16, 16, 17, 17, 17, 17, 18, 18, 18, 18, 19, 19, 19, 19, 20, 20, 20, 20, 21, 21, 21, 21, 16, 72, 78])
      , Sn = new Uint16Array([1, 2, 3, 4, 5, 7, 9, 13, 17, 25, 33, 49, 65, 97, 129, 193, 257, 385, 513, 769, 1025, 1537, 2049, 3073, 4097, 6145, 8193, 12289, 16385, 24577, 0, 0])
      , Tn = new Uint8Array([16, 16, 16, 16, 17, 17, 18, 18, 19, 19, 20, 20, 21, 21, 22, 22, 23, 23, 24, 24, 25, 25, 26, 26, 27, 27, 28, 28, 29, 29, 64, 64])
      , Un = function(e, t, r, n, i, a, o, s) {
        var u, f, c, l, h, d, p, m, v, y = s.bits, g = 0, w = 0, b = 0, k = 0, x = 0, A = 0, _ = 0, I = 0, P = 0, S = 0, T = null, U = 0, O = new Uint16Array(16), D = new Uint16Array(16), E = null, R = 0;
        for (g = 0; g <= _n; g++)
            O[g] = 0;
        for (w = 0; w < n; w++)
            O[t[r + w]]++;
        ...
        for (; ; ) {
            p = g - _,
            o[w] < d ? (m = 0,
            v = o[w]) : o[w] > d ? (m = E[R + o[w]],
            v = T[U + o[w]]) : (m = 96,
            v = 0),
            u = 1 << g - _,
            b = f = 1 << A;
            do {
                i[h + (S >> _) + (f -= u)] = p << 24 | m << 16 | v | 0
            } while (0 !== f);
            for (u = 1 << g - 1; S & u; )
                u >>= 1;
            if (0 !== u ? (S &= u - 1,
            ...
            if (g > x && (S & l) !== c) {
                for (0 === _ && (_ = x),
                h += b,
                I = 1 << (A = g - _); A + _ < k && !((I -= O[A + _]) <= 0); )
                    A++,
                    I <<= 1;
                if (P += 1 << A,
                1 === e && P > 852 || 2 === e && P > 592)
                    return 1;
                i[c = S & l] = x << 24 | A << 16 | h - a | 0
            }
        }
        return 0 !== S && (i[h + S] = g - _ << 24 | 64 << 16 | 0),
        s.bits = x,
        0
    }
      , On = hn.Z_FINISH
    ...
    var Zn, Hn, Yn = function(e) {
        ...
        t = -t) : (r = 1 + (t >> 4),
        t < 48 && (t &= 15)),
        t && (t < 8 || t > 15) ? Cn : (null !== n.window && n.wbits !== t && (n.window = null),
        n.wrap = r,
        n.wbits = t,
        qn(e))
    }, Wn = function(e, t) {
        ...
        r.window = null;
        var n = Xn(e, t);
        return n !== Rn && (e.state = null),
        n
    }, Jn = !0, Qn = function(e) {
        if (Jn) {
            Zn = new Int32Array(512),
            Hn = new Int32Array(32);
            for (var t = 0; t < 144; )
                e.lens[t++] = 8;
            for (; t < 256; )
                e.lens[t++] = 9;
            ...
            for (; t < 288; )
                e.lens[t++] = 8;
            for (Un(1, e.lens, 0, 288, Zn, 0, e.work, {
                bits: 9
            }),
            t = 0; t < 32; )
                e.lens[t++] = 5;
            Un(2, e.lens, 0, 32, Hn, 0, e.work, {
                bits: 5
            }),
            Jn = !1
        }
        ...
        n >= a.wsize ? (a.window.set(t.subarray(r - a.wsize, r), 0),
        a.wnext = 0,
        a.whave = a.wsize) : ((i = a.wsize - a.wnext) > n && (i = n),
        a.window.set(t.subarray(r - n, r - n + i), a.wnext),
        (n -= i) ? (a.window.set(t.subarray(r - n, r), 0),
        a.wnext = n,
        ...
        inflate: function(e, t) {
            var r, n, i, a, o, s, u, f, c, l, h, d, p, m, v, y, g, w, b, k, x, A, _, I, P = 0, S = new Uint8Array(4), T = new Uint8Array([16, 17, 18, 0, 8, 7, 9, 6, 10, 5, 11, 4, 12, 3, 13, 2, 14, 1, 15]);
            if (!e || !e.state || !e.output || !e.input && 0 !== e.avail_in)
                return Cn;
            (r = e.state).mode === jn && (r.mode = 13),
            o = e.next_out,
            i = e.output,
            u = e.avail_out,
            a = e.next_in,
            ...
            e: for (; ; )
                ...
                case 5:
                    ...
                    r.mode = 6;
                case 6:
                    if (1024 & r.flags && ((d = r.length) > s && (d = s),
                    d && (r.head && (x = r.head.extra_len - r.length,
                    r.head.extra || (r.head.extra = new Uint8Array(r.head.extra_len)),
                    r.head.extra.set(n.subarray(a, a + d), x)),
                    512 & r.flags && (r.check = cn(r.check, n, d, a)),
                    s -= d,
                    a += d,
                    r.length -= d),
                    r.length))
                ...
                case 7:
                    if (2048 & r.flags) {
                        ...
                        if (512 & r.flags && (r.check = cn(r.check, n, d, a)),
                        s -= d,
                        a += d,
                        x)
                            break e
                ...
                case 18:
                    ...
                    A = Un(0, r.lens, 0, 19, r.lencode, 0, r.work, _),
                    r.lenbits = _.bits,
                    A) {
                ...
                case 19:
                    for (; r.have < r.nlen + r.ndist; ) {
                        for (; y = (P = r.lencode[f & (1 << r.lenbits) - 1]) >>> 16 & 255,
                        g = 65535 & P,
                        !((v = P >>> 24) <= c); ) {
                            if (0 === s)
                                break e;
                    ...
                    A = Un(1, r.lens, 0, r.nlen, r.lencode, 0, r.work, _),
                    r.lenbits = _.bits,
                    A) {
                    ...
                    A = Un(2, r.lens, r.nlen, r.ndist, r.distcode, 0, r.work, _),
                    r.distbits = _.bits,
                    A) {
                ...
                case 21:
                    ...
                    for (r.back = 0; y = (P = r.lencode[f & (1 << r.lenbits) - 1]) >>> 16 & 255,
                    g = 65535 & P,
                    !((v = P >>> 24) <= c); ) {
                        if (0 === s)
                            break e;
                    ...
                    if (y && 0 == (240 & y)) {
                        for (w = v,
                        b = y,
                        k = g; y = (P = r.lencode[k + ((f & (1 << w + b) - 1) >> w)]) >>> 16 & 255,
                        g = 65535 & P,
                        !(w + (v = P >>> 24) <= c); ) {
                            if (0 === s)
                                break e;
                ...
                case 22:
                    ...
                    r.mode = 23;
                case 23:
                    for (; y = (P = r.distcode[f & (1 << r.distbits) - 1]) >>> 16 & 255,
                    g = 65535 & P,
                    !((v = P >>> 24) <= c); ) {
                        if (0 === s)
                            break e;
                    ...
                    if (0 == (240 & y)) {
                        for (w = v,
                        b = y,
                        k = g; y = (P = r.distcode[k + ((f & (1 << w + b) - 1) >> w)]) >>> 16 & 255,
                        g = 65535 & P,
                        !(w + (v = P >>> 24) <= c); ) {
                            if (0 === s)
                                break e;
                ...
                case 27:
                    if (r.wrap) {
                        ...
                        e.total_out += h,
                        r.total += h,
                        h && (e.adler = r.check = r.flags ? cn(r.check, i, h, o - h) : un(r.check, i, h, o - h)),
                        h = u,
                        (r.flags ? f : Nn(f)) !== r.check) {
            ...
            r.hold = f,
            r.bits = c,
            (r.wsize || h !== e.avail_out && r.mode < zn && (r.mode < 27 || t !== On)) && $n(e, e.output, e.next_out, h - e.avail_out),
            l -= e.avail_in,
            h -= e.avail_out,
            e.total_in += l,
            e.total_out += h,
            r.total += h,
            r.wrap && h && (e.adler = r.check = r.flags ? cn(r.check, i, h, e.next_out - h) : un(r.check, i, h, e.next_out - h)),
            e.data_type = r.bits + (r.last ? 64 : 0) + (r.mode === jn ? 128 : 0) + (20 === r.mode || 15 === r.mode ? 256 : 0),
            (0 === l && 0 === h || t === On) && A === Rn && (A = Vn),
            A
        },
        ...
        inflateGetHeader: function(e, t) {
            if (!e || !e.state)
                return Cn;
            var r = e.state;
            return 0 == (2 & r.wrap) ? Cn : (r.head = t,
            t.done = !1,
            Rn)
        },
        inflateSetDictionary: function(e, t) {
            var r, n = t.length;
            return e && e.state ? 0 !== (r = e.state).wrap && 11 !== r.mode ? Cn : 11 === r.mode && un(1, t, n, 0) !== r.check ? Ln : $n(e, t, n, n) ? (r.mode = 31,
            Fn) : (r.havedict = 1,
            Rn) : Cn
        },
    ...
    function li(e) {
        ...
        var r = ei.inflateInit2(this.strm, t.windowBits);
        if (r !== ai)
            throw new Error(ln[r]);
        if (this.header = new ti,
        ei.inflateGetHeader(this.strm, this.header),
        t.dictionary && ("string" == typeof t.dictionary ? t.dictionary = wn(t.dictionary) : "[object ArrayBuffer]" === ri.call(t.dictionary) && (t.dictionary = new Uint8Array(t.dictionary)),
        t.raw && (r = ei.inflateSetDictionary(this.strm, t.dictionary)) !== ai))
            throw new Error(ln[r])
    }
    function hi(e, t) {
        var r = new li(t);
        if (r.push(e),
        r.err)
            throw r.msg || ln[r.err];
        return r.result
    }
    li.prototype.push = function(e, t) {
        var r, n, i, a = this.strm, o = this.options.chunkSize, s = this.options.dictionary;
        if (this.ended)
            return !1;
        for (n = t === ~~t ? t : !0 === t ? ii : ni,
        "[object ArrayBuffer]" === ri.call(e) ? a.input = new Uint8Array(e) : a.input = e,
        a.next_in = 0,
        a.avail_in = a.input.length; ; ) {
            for (0 === a.avail_out && (a.output = new Uint8Array(o),
            a.next_out = 0,
            a.avail_out = o),
            (r = ei.inflate(a, n)) === si && s && ((r = ei.inflateSetDictionary(a, s)) === ai ? r = ei.inflate(a, n) : r === fi && (r = si)); a.avail_in > 0 && r === oi && a.state.wrap > 0 && 0 !== e[a.next_in]; )
                ei.inflateReset(a),
                r = ei.inflate(a, n);
            switch (r) {
            case ui:
            ...
            if (i = a.avail_out,
            a.next_out && (0 === a.avail_out || r === oi))
                if ("string" === this.options.to) {
                    var u = kn(a.output, a.next_out)
                      , f = a.next_out - u
                      , c = bn(a.output, u);
                    a.next_out = f,
                    a.avail_out = o - f,
                    f && a.output.set(a.output.subarray(u, u + f), 0),
                    this.onData(c)
                } else
                    this.onData(a.output.length === a.next_out ? a.output : a.output.subarray(0, a.next_out));
            if (r !== ai || 0 !== i) {
                if (r === oi)
                    return r = ei.inflateEnd(this.strm),
                    this.onEnd(r),
                    this.ended = !0,
                    !0;
                if (0 === a.avail_in)
    ...
    li.prototype.onEnd = function(e) {
        e === ai && ("string" === this.options.to ? this.result = this.chunks.join("") : this.result = mn(this.chunks)),
        this.chunks = [],
        this.err = e,
    ...
    var mi = function(e) {
        ...
        return c(r, [{
            key: "decodeBlock",
            value: function(e) {
                return di(new Uint8Array(e)).buffer
            }
        }]),
        r
    }(wr)
    ...
    !function(e) {
        ...
        !function() {
            var t, r, n, i, a, o, s, u, f = (t = {
                ...
                decode: function(e, o) {
                    var s = (o = o || {}).encodedMaskData || null === o.encodedMaskData
                      ...
                      , c = r(u, o.pixelType || Float32Array, o.encodedMaskData, f, o.returnMask)
                      , l = {
                        width: u.width,
                        height: u.height,
                    ...
                    return c.resultMask && (l.maskData = c.resultMask),
                    o.returnEncodedMask && u.mask && (l.encodedMaskData = u.mask.bitset ? u.mask.bitset : null),
                    o.returnFileInfo && (l.fileInfo = n(u),
                    o.computeUsedBitDepths && (l.fileInfo.bitDepths = i(u))),
                    l
                }
            },
            r = function(e, t, r, n, i) {
                var a, s, u, f = 0, c = e.pixels.numBlocksX, l = e.pixels.numBlocksY, h = Math.floor(e.width / c), d = Math.floor(e.height / l), p = 2 * e.maxZError, m = Number.MAX_VALUE;
                r = r || (e.mask ? e.mask.bitset : null),
                s = new t(e.width * e.height),
                i && r && (u = new Uint8Array(e.width * e.height));
                for (var v, y, g = new Float32Array(h * d), w = 0; w <= l; w++) {
                    var b = w !== l ? d : e.height % l;
                    if (0 !== b)
                        for (var k = 0; k <= c; k++) {
                            var x = k !== c ? h : e.width % c;
                            if (0 !== x) {
                                var A, _, I, P, S = w * e.width * d + k * h, T = e.width - x, U = e.pixels.blocks[f];
                                if (U.encoding < 2 ? (0 === U.encoding ? A = U.rawData : (o(U.stuffedData, U.bitsPerPixel, U.numValidPixels, U.offset, p, g, e.pixels.maxValue),
                                A = g),
                                _ = 0) : I = 2 === U.encoding ? 0 : U.offset,
                                r)
                                    for (y = 0; y < b; y++) {
                                        for (7 & S && (P = r[S >> 3],
                                        P <<= 7 & S),
                                ...
                                if (1 === U.encoding && _ !== U.numValidPixels)
            ...
            a = function(e, t, r) {
                ...
                if (n.fileIdentifierString = String.fromCharCode.apply(null, i),
                "CntZImage" !== n.fileIdentifierString.trim())
                    throw "Unexpected file identifier string: " + n.fileIdentifierString;
                t += 10;
                var a = new DataView(e,t,24);
                if (n.fileVersion = a.getInt32(0, !0),
                ...
                !r)
                    ...
                    n.mask.numBytes > 0) {
                        ...
                        if (-32768 !== s || f < o.length)
                            throw "Unexpected end of mask RLE encoding";
                        n.mask.bitset = o,
                        t += n.mask.numBytes
                    } else
                        0 == (n.mask.numBytes | n.mask.numBlocksY | n.mask.maxValue) && (n.mask.bitset = new Uint8Array(Math.ceil(n.width * n.height / 8)));
                ...
                for (var m = 0, v = 0; v < p; v++)
                    for (var y = 0; y < d; y++) {
                        ...
                        b.encoding = 63 & k,
                        b.encoding > 3)
                            throw "Invalid block encoding (" + b.encoding + ")";
                        if (2 !== b.encoding) {
                            if (0 !== k && 2 !== k) {
                                if (k >>= 6,
                                b.offsetType = k,
                                2 === k)
                                    b.offset = a.getInt8(1),
                                    g++;
                                else if (1 === k)
                                    b.offset = a.getInt16(1, !0),
                                    g += 2;
                                else {
                                    if (0 !== k)
                                        throw "Invalid block offset type";
                                    b.offset = a.getFloat32(1, !0),
                                    g += 4
                                }
                                if (1 === b.encoding)
                                    if (k = a.getUint8(g),
                                    ...
                                    b.bitsPerPixel = 63 & k,
                                    k >>= 6,
                                    b.numValidPixelsType = k,
                                    2 === k)
                                        b.numValidPixels = a.getUint8(g),
                                        g++;
                                    else if (1 === k)
                                        b.numValidPixels = a.getUint16(g, !0),
                                        g += 2;
                                    else {
                                        if (0 !== k)
                                            throw "Invalid valid pixel count type";
                                        b.numValidPixels = a.getUint32(g, !0),
                                        g += 4
                                    }
                            }
                            var x;
                            ...
                            3 !== b.encoding)
                                if (0 === b.encoding) {
                                    ...
                                    x = new ArrayBuffer(4 * A),
                                    new Uint8Array(x).set(new Uint8Array(e,t,4 * A));
                                    var _ = new Float32Array(x);
                                    b.rawData = _,
                                    t += 4 * A
                                } else if (1 === b.encoding) {
                                    var I = Math.ceil(b.numValidPixels * b.bitsPerPixel / 8)
                                      , P = Math.ceil(I / 4);
                                    x = new ArrayBuffer(4 * P),
                                    new Uint8Array(x).set(new Uint8Array(e,t,I)),
                                    b.stuffedData = new Uint32Array(x),
                                    t += I
                                }
                        } else
                            t++
                    }
                return n.eofOffset = t,
                n
            }
            ,
            o = function(e, t, r, n, i, a, o) {
                var s, u, f, c = (1 << t) - 1, l = 0, h = 0, d = Math.ceil((o - n) / i), p = 4 * e.length - Math.ceil(t * r / 8);
                for (e[e.length - 1] <<= 8 * p,
                s = 0; s < r; s++) {
                    if (0 === h && (f = e[l++],
                    h = 32),
                    h >= t)
            ...
            ,
            t), c = function() {
                var e = function(e, t, r, n, i, a, o, s) {
                    var u, f, c, l, h, d = (1 << r) - 1, p = 0, m = 0, v = 4 * e.length - Math.ceil(r * n / 8);
                    if (e[e.length - 1] <<= 8 * v,
                    i)
                        for (u = 0; u < n; u++)
                            0 === m && (c = e[p++],
                  ...
                  , t = function(e, t, r, n, i, a) {
                    var o, s = (1 << t) - 1, u = 0, f = 0, c = 0, l = 0, h = 0, d = [], p = 4 * e.length - Math.ceil(t * r / 8);
                    e[e.length - 1] <<= 8 * p;
                    var m = Math.ceil((a - n) / i);
                    for (f = 0; f < r; f++)
                        0 === l && (o = e[u++],
                        l = 32),
                        l >= t ? (h = o >>> l - t & s,
                  ...
                  , r = function(e, t, r, n, i, a, o, s) {
                    var u, f, c, l, h = (1 << r) - 1, d = 0, p = 0, m = 0;
                    if (i)
                        for (u = 0; u < n; u++)
                            0 === p && (c = e[d++],
                            p = 32,
                  ...
                  , n = function(e, t, r, n, i, a) {
                    var o, s = (1 << t) - 1, u = 0, f = 0, c = 0, l = 0, h = 0, d = 0, p = [], m = Math.ceil((a - n) / i);
                    for (f = 0; f < r; f++)
                        0 === l && (o = e[u++],
                        l = 32,
                        d = 0),
                  ...
                  , i = function(e, t, r, n) {
                    var i, a, o, s, u = (1 << r) - 1, f = 0, c = 0, l = 4 * e.length - Math.ceil(r * n / 8);
                    for (e[e.length - 1] <<= 8 * l,
                    i = 0; i < n; i++)
                        0 === c && (o = e[f++],
                        c = 32),
                        c >= r ? (a = o >>> c - r & u,
                  ...
                  , a = function(e, t, r, n) {
                    var i, a, o, s, u = (1 << r) - 1, f = 0, c = 0, l = 0;
                    for (i = 0; i < n; i++)
                        0 === c && (o = e[f++],
                        c = 32,
                        l = 0),
                  ...
                  , o = {
                    ...
                    computeChecksumFletcher32: function(e) {
                        ...
                        return 1 & n && (r += t += e[a] << 8),
                        ((r = (65535 & r) + (r >>> 16)) << 16 | (t = (65535 & t) + (t >>> 16))) >>> 0
                    },
                    readHeaderInfo: function(e, t) {
                        var r = t.ptr
                          , n = new Uint8Array(e,r,6)
                          , i = {};
                        if (i.fileIdentifierString = String.fromCharCode.apply(null, n),
                        0 !== i.fileIdentifierString.lastIndexOf("Lerc2", 0))
                            throw "Unexpected file identifier string (expect Lerc2 ): " + i.fileIdentifierString;
                        r += 6;
                        var a, o = new DataView(e,r,8), s = o.getInt32(0, !0);
                        if (i.fileVersion = s,
                        r += 4,
                        s >= 3 && (i.checksum = o.getUint32(4, !0),
                        r += 4),
                        o = new DataView(e,r,12),
                        i.height = o.getUint32(0, !0),
                        i.width = o.getUint32(4, !0),
                        r += 8,
                        s >= 4 ? (i.numDims = o.getUint32(8, !0),
                        r += 4) : i.numDims = 1,
                        o = new DataView(e,r,40),
                        i.numValidPixel = o.getUint32(0, !0),
                        i.microBlockSize = o.getInt32(4, !0),
                        i.blobSize = o.getInt32(8, !0),
                        i.imageType = o.getInt32(12, !0),
                        i.maxZError = o.getFloat64(16, !0),
                        i.zMin = o.getFloat64(24, !0),
                        i.zMax = o.getFloat64(32, !0),
                        r += 40,
                        t.headerInfo = i,
                        t.ptr = r,
                        s >= 3 && (a = s >= 4 ? 52 : 48,
                        this.computeChecksumFletcher32(new Uint8Array(e,r - a,i.blobSize - 14)) !== i.checksum))
                    ...
                    readMask: function(e, t) {
                        var r, n, i = t.ptr, a = t.headerInfo, o = a.width * a.height, s = a.numValidPixel, u = new DataView(e,i,4), f = {};
                        if (f.numBytes = u.getUint32(0, !0),
                        i += 4,
                        (0 === s || o === s) && 0 !== f.numBytes)
                            throw "invalid mask";
                        if (0 === s)
                            r = new Uint8Array(Math.ceil(o / 8)),
                            f.bitset = r,
                            n = new Uint8Array(o),
                            t.pixels.resultMask = n,
                            i += f.numBytes;
                        else if (f.numBytes > 0) {
                            r = new Uint8Array(Math.ceil(o / 8));
                            var c = (u = new DataView(e,i,f.numBytes)).getInt16(0, !0)
                              , l = 2
                              , h = 0
                              , d = 0;
                            do {
                    ...
                    readDataOneSweep: function(e, t, r, n) {
                        var i, a = t.ptr, s = t.headerInfo, u = s.numDims, f = s.width * s.height, c = s.imageType, l = s.numValidPixel * o.getDataTypeSize(c) * u, h = t.pixels.resultMask;
                        if (r === Uint8Array)
                            i = new Uint8Array(e,a,l);
                        else {
                            var d = new ArrayBuffer(l);
                            new Uint8Array(d).set(new Uint8Array(e,a,l)),
                            i = new r(d)
                        }
                        if (i.length === f * u)
                            t.pixels.resultPixels = n ? o.swapDimensionOrder(i, f, u, r, !0) : i;
                        else {
                                ...
                                if (n) {
                                    for (m = 0; m < f; m++)
                                        if (h[m])
                                            ...
                                            v = 0; v < u; v++,
                                            y += f)
                                                t.pixels.resultPixels[y] = i[p++]
                                } else
                                    for (m = 0; m < f; m++)
                                        if (h[m])
                                            for (y = m * u,
                                            v = 0; v < u; v++)
                                                t.pixels.resultPixels[y + v] = i[p++]
                            } else
                                for (m = 0; m < f; m++)
                                    h[m] && (t.pixels.resultPixels[m] = i[p++])
                        }
                        return a += l,
                        t.ptr = a,
                        !0
                    ...
                    readHuffmanTree: function(e, t) {
                        ...
                        var m = e.byteLength - t.ptr
                          , v = Math.ceil(m / 4)
                          , y = new ArrayBuffer(4 * v);
                        new Uint8Array(y).set(new Uint8Array(e,t.ptr,m));
                        var g, w = new Uint32Array(y), b = 0, k = 0;
                        for (g = w[0],
                        c = a; c < u; c++)
                            (d = p[l = c - (c < i ? 0 : i)].first) > 0 && (p[l].second = g << b >>> 32 - d,
                            32 - b >= d ? 32 === (b += d) && (b = 0,
                            g = w[++k]) : (b += d - 32,
                            g = w[++k],
                            p[l].second |= g >>> 32 - b));
                        ...
                        for (c = 0; c < p.length; c++)
                            void 0 !== p[c] && (x = Math.max(x, p[c].first));
                        A = x >= r ? r : x;
                        var I, P, S, T, U, O = [];
                        for (c = a; c < u; c++)
                            if ((d = p[l = c - (c < i ? 0 : i)].first) > 0)
                                if (I = [d, l],
                                d <= A)
                                    for (P = p[l].second << A - d,
                                    S = 1 << A - d,
                                    h = 0; h < S; h++)
                                        O[P | h] = I;
                                else
                                    ...
                                    U = _,
                                    T = d - 1; T >= 0; T--)
                                        P >>> T & 1 ? (U.right || (U.right = new s),
                                        U = U.right) : (U.left || (U.left = new s),
                                        U = U.left),
                                        0 !== T || U.val || (U.val = I[1]);
                        return {
                            decodeLut: O,
                    ...
                    readHuffman: function(e, t, r, n) {
                        var i, a, s, u, f, c, l, h, d, p = t.headerInfo.numDims, m = t.headerInfo.height, v = t.headerInfo.width, y = v * m, g = this.readHuffmanTree(e, t), w = g.decodeLut, b = g.tree, k = g.stuffedData, x = g.srcPtr, A = g.bitPos, _ = g.numBitsLUTQick, I = g.numBitsLUT, P = 0 === t.headerInfo.imageType ? 128 : 0, S = t.pixels.resultMask, T = 0;
                        A > 0 && (x++,
                        A = 0);
                        var U, O = k[x], D = 1 === t.encodeMode, E = new r(y * p), R = E;
                        if (p < 2 || D) {
                            for (U = 0; U < p; U++)
                                if (p > 1 && (R = new r(E.buffer,y * U,y),
                                T = 0),
                                t.headerInfo.numValidPixel === v * m)
                                    for (h = 0,
                                    c = 0; c < m; c++)
                                        for (l = 0; l < v; l++,
                                        h++) {
                                            if (a = 0,
                                            f = u = O << A >>> 32 - _,
                                            32 - A < _ && (f = u |= k[x + 1] >>> 64 - A - _),
                                            w[f])
                                                a = w[f][1],
                                                A += w[f][0];
                                            else
                                                for (f = u = O << A >>> 32 - I,
                                                32 - A < I && (f = u |= k[x + 1] >>> 64 - A - I),
                                                i = b,
                                                d = 0; d < I; d++)
                                                    if (!(i = u >>> I - d - 1 & 1 ? i.right : i.left).left && !i.right) {
                                                        a = i.val,
                                                        A = A + d + 1;
                                                        break
                                                    }
                                    ...
                                    c = 0; c < m; c++)
                                        ...
                                        h++)
                                            if (S[h]) {
                                                ...
                                                O = k[++x]),
                                                s = a - P,
                                                D ? (l > 0 && S[h - 1] ? s += T : c > 0 && S[h - v] ? s += R[h - v] : s += T,
                                                s &= 255,
                                                R[h] = s,
                                                T = s) : R[h] = s
                                            }
                        ...
                        t.ptr = t.ptr + 4 * (x + 1) + (A > 0 ? 4 : 0),
                        t.pixels.resultPixels = E,
                        p > 1 && !n && (t.pixels.resultPixels = o.swapDimensionOrder(E, y, p, r))
                    },
                    decodeBits: function(o, s, u, f, c) {
                        var l = s.headerInfo
                          , h = l.fileVersion
                          , d = 0
                          , p = o.byteLength - s.ptr >= 5 ? 5 : o.byteLength - s.ptr
                          , m = new DataView(o,s.ptr,p)
                          , v = m.getUint8(0);
                        d++;
                        var y = v >> 6
                          , g = 0 === y ? 4 : 3 - y
                        ...
                        var x, A, _, I, P, S, T, U, O, D = 2 * l.maxZError, E = l.numDims > 1 ? l.maxValues[c] : l.zMax;
                        if (w) {
                            for (s.counter.lut++,
                            U = m.getUint8(d),
                            d++,
                            I = Math.ceil((U - 1) * b / 8),
                            P = Math.ceil(I / 4),
                            A = new ArrayBuffer(4 * P),
                            _ = new Uint8Array(A),
                            s.ptr += d,
                            _.set(new Uint8Array(o,s.ptr,I)),
                            T = new Uint32Array(A),
                            s.ptr += I,
                            O = 0; U - 1 >>> O; )
                                O++;
                            ...
                            P = Math.ceil(I / 4),
                            A = new ArrayBuffer(4 * P),
                            (_ = new Uint8Array(A)).set(new Uint8Array(o,s.ptr,I)),
                            x = new Uint32Array(A),
                            s.ptr += I,
                            S = h >= 3 ? n(T, b, U - 1, f, D, E) : t(T, b, U - 1, f, D, E),
                            h >= 3 ? r(x, u, O, k, S) : e(x, u, O, k, S)
                        } else
                            s.counter.bitstuffer++,
                            O = b,
                            s.ptr += d,
                            O > 0 && (I = Math.ceil(k * O / 8),
                            P = Math.ceil(I / 4),
                            A = new ArrayBuffer(4 * P),
                            (_ = new Uint8Array(A)).set(new Uint8Array(o,s.ptr,I)),
                            x = new Uint32Array(A),
                            s.ptr += I,
                            h >= 3 ? null == f ? a(x, u, O, k) : r(x, u, O, k, !1, f, D, E) : null == f ? i(x, u, O, k) : e(x, u, O, k, !1, f, D, E))
                    },
                    readTiles: function(e, t, r, n) {
                        var i = t.headerInfo
                          , a = i.width
                          , s = i.height
                          , u = a * s
                          , f = i.microBlockSize
                          , c = i.imageType
                          , l = o.getDataTypeSize(c)
                          , h = Math.ceil(a / f)
                          , d = Math.ceil(s / f);
                        t.pixels.numBlocksY = d,
                        t.pixels.numBlocksX = h,
                        t.pixels.ptr = 0;
                        var p, m, v, y, g, w, b, k, x, A, _ = 0, I = 0, P = 0, S = 0, T = 0, U = 0, O = 0, D = 0, E = 0, R = 0, M = 0, B = 0, C = 0, L = 0, F = 0, V = new r(f * f), G = s % f || f, j = a % f || f, z = i.numDims, N = t.pixels.resultMask, K = t.pixels.resultPixels, Z = i.fileVersion >= 5 ? 14 : 15, H = i.zMax;
                        for (P = 0; P < d; P++)
                            for (T = P !== d - 1 ? f : G,
                            S = 0; S < h; S++)
                                for (R = P * a * f + S * f,
                                ...
                                k = 0; k < z; k++) {
                                    if (z > 1 ? (A = K,
                                    R = P * a * f + S * f,
                                    K = new r(t.pixels.resultPixels.buffer,u * k * l,u),
                                    H = i.maxValues[k]) : A = null,
                                    O = e.byteLength - t.ptr,
                                    m = {},
                                    F = 0,
                                    D = (p = new DataView(e,t.ptr,Math.min(10, O))).getUint8(0),
                                    F++,
                                    x = i.fileVersion >= 5 ? 4 & D : 0,
                                    E = D >> 6 & 255,
                                    (D >> 2 & Z) !== (S * f >> 3 & Z))
                                    ...
                                    if ((g = 3 & D) > 3)
                                        throw t.ptr += F,
                                        "Invalid block encoding (" + g + ")";
                                    if (2 !== g)
                                        if (0 === g) {
                                            if (x)
                                                throw "integrity issue";
                                            if (t.counter.uncompressed++,
                                            t.ptr += F,
                                            B = (B = T * U * l) < (C = e.byteLength - t.ptr) ? B : C,
                                            v = new ArrayBuffer(B % l == 0 ? B : B + l - B % l),
                                            new Uint8Array(v).set(new Uint8Array(e,t.ptr,B)),
                                            y = new r(v),
                                            L = 0,
                                            N)
                                                for (_ = 0; _ < T; _++) {
                                            ...
                                            t.ptr += L * l
                                        } else if (w = o.getDataTypeUsed(x && c < 6 ? 4 : c, E),
                                        b = o.getOnePixel(m, F, w, p),
                                        F += o.getDataTypeSize(w),
                                        3 === g)
                                            if (t.ptr += F,
                                            t.counter.constantoffset++,
                                            N)
                                                for (_ = 0; _ < T; _++) {
                                                    for (I = 0; I < U; I++)
                                                        N[R] && (K[R] = x ? Math.min(H, A[R] + b) : b),
                                                        R++;
                                                    R += M
                                                }
                                            else
                                                for (_ = 0; _ < T; _++) {
                                                    for (I = 0; I < U; I++)
                                                        K[R] = x ? Math.min(H, A[R] + b) : b,
                                                        R++;
                                                    R += M
                                                }
                                        else if (t.ptr += F,
                                        o.decodeBits(e, t, V, b, k),
                                        F = 0,
                                        x)
                                            if (N)
                                                for (_ = 0; _ < T; _++) {
                        ...
                        z > 1 && !n && (t.pixels.resultPixels = o.swapDimensionOrder(t.pixels.resultPixels, u, z, r))
                    },
                    ...
                    swapDimensionOrder: function(e, t, r, n, i) {
                        var a = 0
                          , o = 0
                          , s = 0
                          , u = 0
                  ...
                  , u = {
                    decode: function(e, t) {
                        var r = (t = t || {}).noDataValue
                          , n = 0
                          , i = {};
                        i.ptr = t.inputOffset || 0,
                        i.pixels = {},
                        o.readHeaderInfo(e, i);
                        var a = i.headerInfo
                          , s = a.fileVersion
                          , u = o.getDataTypeArray(a.imageType);
                        if (s > 5)
                            throw "unsupported lerc version 2." + s;
                        o.readMask(e, i),
                        a.numValidPixel === a.width * a.height || i.pixels.resultMask || (i.pixels.resultMask = t.maskData);
                        var f = a.width * a.height;
                        i.pixels.resultPixels = new u(f * a.numDims),
                        i.counter = {
                            onesweep: 0,
                            uncompressed: 0,
                            lut: 0,
                        ...
                        var c, l = !t.returnPixelInterleavedDims;
                        if (0 !== a.numValidPixel)
                            if (a.zMax === a.zMin)
                                o.constructConstantSurface(i, l);
                            else if (s >= 4 && o.checkMinMaxRanges(e, i))
                                o.constructConstantSurface(i, l);
                            else {
                                ...
                                if (i.ptr++,
                                d)
                                    o.readDataOneSweep(e, i, u, l);
                                else if (s > 1 && a.imageType <= 1 && Math.abs(a.maxZError - .5) < 1e-5) {
                                    var p = h.getUint8(1);
                                    if (i.ptr++,
                                    i.encodeMode = p,
                                    p > 2 || s < 4 && p > 1)
                                        throw "Invalid Huffman flag " + p;
                                    p ? o.readHuffman(e, i, u, l) : o.readTiles(e, i, u, l)
                                } else
                                    o.readTiles(e, i, u, l)
                            }
                        i.eofOffset = i.ptr,
                        t.inputOffset ? (c = i.headerInfo.blobSize + t.inputOffset - i.ptr,
                        Math.abs(c) >= 1 && (i.eofOffset = t.inputOffset + i.headerInfo.blobSize)) : (c = i.headerInfo.blobSize - i.ptr,
                        Math.abs(c) >= 1 && (i.eofOffset = i.headerInfo.blobSize));
                        var m = {
                            width: a.width,
                            height: a.height,
                        ...
                        if (i.pixels.resultMask && o.isValidPixelValue(a.imageType, r)) {
                            var v = i.pixels.resultMask;
                            for (n = 0; n < f; n++)
                                v[n] || (m.pixelData[n] = r);
                            m.noDataValue = r
                        }
                        return i.noDataValue = r,
                        t.returnFileInfo && (m.fileInfo = o.formatFileInfo(i)),
                        m
                    },
                    getBandCount: function(e) {
                        for (var t = 0, r = 0, n = {
                            ...
                            o.readHeaderInfo(e, n),
                            r += n.headerInfo.blobSize,
                            t++,
                            n.ptr = r;
                        return t
                    }
                ...
                return u
            }(), l = (s = new ArrayBuffer(4),
            u = new Uint8Array(s),
            new Uint32Array(s)[0] = 1,
            1 === u[0]), h = {
                decode: function(e, t) {
                    if (!l)
                        throw "Big endian system is not supported.";
                    var r, n, i = (t = t || {}).inputOffset || 0, a = new Uint8Array(e,i,10), o = String.fromCharCode.apply(null, a);
                    if ("CntZImage" === o.trim())
                        r = f,
                        n = 1;
                    else {
                        if ("Lerc2" !== o.substring(0, 5))
                            throw "Unexpected file identifier string: " + o;
                        r = c,
                        n = 2
                    }
                    for (var s, u, h, d, p, m, v = 0, y = e.byteLength - 10, g = [], w = {
                        width: 0,
                        height: 0,
                        pixels: [],
                        ...
                        var k = r.decode(e, {
                            ...
                            maskData: h,
                            returnMask: 0 === v,
                            returnEncodedMask: 0 === v,
                            returnFileInfo: !0,
                            returnPixelInterleavedDims: t.returnPixelInterleavedDims,
                            pixelType: t.pixelType || null,
                            noDataValue: t.noDataValue || null
                        });
                        i = k.fileInfo.eofOffset,
                        h = k.maskData,
                        0 === v && (s = k.encodedMaskData,
                        w.width = k.width,
                        w.height = k.height,
                        w.dimCount = k.dimCount || 1,
                        w.pixelType = k.pixelType || k.fileInfo.pixelType,
                        w.mask = h),
                        n > 1 && (h && g.push(h),
                        k.fileInfo.mask && k.fileInfo.mask.numBytes > 0 && b++),
                        v++,
                        w.pixels.push(k.pixelData),
                        w.statistics.push({
                            minValue: k.minValue,
                            maxValue: k.maxValue,
                    ...
                    if (n > 1 && b > 1) {
                        for (m = w.width * w.height,
                        w.bandMasks = g,
                        (h = new Uint8Array(m)).set(g[0]),
                        d = 1; d < g.length; d++)
                            for (u = g[d],
                            p = 0; p < m; p++)
                                h[p] = h[p] & u[p];
    ...
    var Ai = function(e) {
        ...
        function r(e) {
            var n;
            return b(this, r),
            (n = t.call(this)).planarConfiguration = void 0 !== e.PlanarConfiguration ? e.PlanarConfiguration : 1,
            n.samplesPerPixel = void 0 !== e.SamplesPerPixel ? e.SamplesPerPixel : 1,
            n.addCompression = e.LercParameters[ue.AddCompression],
            n
        }
        return c(r, [{
            key: "decodeBlock",
            ...
            value: (t = u(x.mark((function e(t, r) {
                ...
                return x.wrap((function(e) {
                    for (; ; )
                        ...
                        case 3:
                            return i = e.sent,
                            "undefined" != typeof document ? ((a = document.createElement("canvas")).width = i.width,
                            a.height = i.height) : a = new OffscreenCanvas(i.width,i.height),
                            (o = a.getContext("2d")).drawImage(i, 0, 0),
                            e.abrupt("return", o.getImageData(0, 0, i.width, i.height).data.buffer);
                        case 8:
                        case "end":
                            return e.stop()
                        }
    ...
    var Ui = Object.freeze({
        ...
        create: function() {
            ...
            return new Ti("undefined" == typeof Blob ? "data:application/javascript;base64," + Buffer.from(e, "binary").toString("base64") : URL.createObjectURL(new Blob([e],{
    ...
    e.addDecoder = xe,
    e.default = Ur,
    e.fromArrayBuffer = function(e, t) {
    ...
    e.setLogger = function() {
        arguments.length > 0 && void 0 !== arguments[0] || new mr
    }
    ,
