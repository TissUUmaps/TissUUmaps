!(function (t, e) {
    ...
    for (var i = new n(null, null), o = i, s = i; ; ) {
      ...
      if (u < 0) {
        ...
        if (r(t, e.right.key) > 0) {
          l = e.right;
          if (((e.right = l.left), (l.left = e), null === (e = l).right)) break;
        }
  ...
  function s(t, e, r, i) {
    ...
    var u = i(t, (r = o(t, r, i)).key);
    return (
      u < 0
        ? ((s.left = r.left), (s.right = r), (r.left = null))
        : u >= 0 && ((s.right = r.right), (s.left = r), (r.right = null)),
      s
    );
  }
  function u(t, e, r) {
  ...
  function l(t, e, r, n, i) {
    if (t) {
      n(e + (r ? "└── " : "├── ") + i(t) + "\n");
      var o = e + (r ? "    " : "│   ");
      t.left && l(t.left, o, !1, n, i), t.right && l(t.right, o, !0, n, i);
    }
  }
  var h = (function () {
    function t(t) {
    ...
    return (
      (t.prototype.insert = function (t, e) {
        return (
          this._size++, (this._root = s(t, e, this._root, this._comparator))
        );
      }),
      ...
      (t.prototype.load = function (t, e, r) {
        ...
        if ((r && p(t, e, 0, i - 1, o), null === this._root))
          (this._root = f(t, e, 0, i)), (this._size = i);
        else {
          var s = (function (t, e, r) {
            ...
            for (; null !== s && null !== u; )
              r(s.key, u.key) < 0
                ...
                : ((o.next = u), (u = u.next)),
                (o = o.next);
            null !== s ? (o.next = s) : null !== u && (o.next = u);
            return i.next;
          })(
            this.toList(),
            (function (t, e) {
          ...
          (i = this._size + i), (this._root = a({ head: s }, 0, i));
        }
        return this;
      }),
      ...
      (t.prototype.update = function (t, e, r) {
        var n = this._comparator,
          ...
          l = i.left,
          h = i.right;
        n(t, e) < 0 ? (h = s(e, r, h, n)) : (l = s(e, r, l, n)),
  ...
  function f(t, e, r, i) {
    ...
    if (o > 0) {
      var s = r + Math.floor(o / 2),
        ...
        l = e[s],
        h = new n(u, l);
      return (h.left = f(t, e, r, s)), (h.right = f(t, e, s + 1, i)), h;
    }
    return null;
  }
  function a(t, e, r) {
    ...
    if (n > 0) {
      var i = e + Math.floor(n / 2),
        ...
        s = t.head;
      return (
        (s.left = o), (t.head = t.head.next), (s.right = a(t, i + 1, r)), s
      );
    }
    return null;
  }
  function p(t, e, r, n, i) {
    if (!(r >= n)) {
      for (var o = t[(r + n) >> 1], s = r - 1, u = n + 1; ; ) {
        ...
        if (s >= u) break;
        var l = t[s];
        (t[s] = t[u]), (t[u] = l), (l = e[s]), (e[s] = e[u]), (e[u] = l);
      }
      p(t, e, r, u, i), p(t, e, u + 1, n, i);
    }
  }
  var y = function (t, e) {
    ...
    v = Number.EPSILON;
  void 0 === v && (v = Math.pow(2, -52));
  var c = v * v,
    x = function (t, e) {
      if (-v < t && t < v && -v < e && e < v) return 0;
      var r = t - e;
      return r * r < c * t * e ? 0 : t < e ? -1 : 1;
    },
    b = (function () {
      function e() {
        t(this, e), this.reset();
    ...
    w = function (t, e, r) {
      var n = { x: e.x - t.x, y: e.y - t.y },
        i = { x: r.x - t.x, y: r.y - t.y };
      return S(i, n) / k(i) / k(n);
    },
    R = function (t, e, r) {
      return 0 === e.y ? null : { x: t.x + (e.x / e.y) * (r - t.y), y: r };
    },
    I = function (t, e, r) {
      return 0 === e.x ? null : { x: r, y: t.y + (e.y / e.x) * (r - t.x) };
    },
    P = (function () {
      function e(r, n) {
        t(this, e),
                ...
                n = function (n) {
                  ...
                  r.set(n, {
                    sine:
                      ...
                      (o = t.point),
                      (s = h.point),
                      (u = { x: o.x - i.x, y: o.y - i.y }),
                      (l = { x: s.x - i.x, y: s.y - i.y }),
                      E(l, u) / k(l) / k(u)),
                    cosine: w(e.point, t.point, h.point),
                  });
                };
              return function (t, e) {
        ...
        r(e, null, [
          {
            ...
            value: function (t, e) {
              ...
              if (r < n) {
                if (u < s && u < l) return 1;
                if (u > s && u > l) return -1;
                var f = t.comparePoint(e.leftSE.point);
                if (f < 0) return 1;
                if (f > 0) return -1;
                var a = e.comparePoint(t.rightSE.point);
                return 0 !== a ? a : -1;
              }
              if (r > n) {
                if (s < u && s < h) return -1;
            ...
            },
            {
              ...
              value: function (t) {
                ...
                var i = this.leftSE.point,
                  ...
                  s = t.leftSE.point,
                  u = t.rightSE.point,
                  l = y(e, s) && 0 === this.comparePoint(s),
                  h = y(r, i) && 0 === t.comparePoint(i),
                  f = y(e, u) && 0 === this.comparePoint(u),
                  a = y(r, o) && 0 === t.comparePoint(o);
                if (h && l) return a && !f ? o : !a && f ? u : null;
                if (h) return f && i.x === u.x && i.y === u.y ? null : i;
                if (l) return a && o.x === s.x && o.y === s.y ? null : s;
                if (a && f) return null;
                if (a) return o;
                if (f) return u;
                var p = (function (t, e, r, n) {
                  ...
                  if (0 === e.y) return R(r, n, t.y);
                  if (0 === n.y) return R(t, e, r.y);
                  var i = E(e, n);
                  if (0 == i) return null;
                  var o = { x: r.x - t.x, y: r.y - t.y },
                    ...
                    u = E(o, n) / i;
                  return {
                    x: (t.x + u * e.x + (r.x + s * n.x)) / 2,
                    y: (t.y + u * e.y + (r.y + s * n.y)) / 2,
                  };
                })(i, this.vector(), s, t.vector());
                return null === p ? null : y(n, p) ? d.round(p.x, p.y) : null;
              },
            },
            {
              key: "split",
              value: function (t) {
                ...
                var u = new e(i, s, this.rings.slice(), this.windings.slice());
                return (
                  P.comparePoints(u.leftSE.point, u.rightSE.point) > 0 &&
                    u.swapEvents(),
                  P.comparePoints(this.leftSE.point, this.rightSE.point) > 0 &&
                    this.swapEvents(),
            ...
            },
            {
              ...
              value: function (t) {
                ...
                if (0 !== i) {
                  ...
                  for (var u = 0, l = n.rings.length; u < l; u++) {
                    var h = n.rings[u],
                      f = n.windings[u],
                      a = r.rings.indexOf(h);
                    -1 === a
                      ? (r.rings.push(h), r.windings.push(f))
                      : (r.windings[a] += f);
                  }
                  (n.rings = null),
                    (n.windings = null),
              ...
              value: function () {
                ...
                for (
                  ...
                  var s = this.rings[i],
                    u = this.windings[i],
                    l = e.indexOf(s);
                  -1 === l ? (e.push(s), r.push(u)) : (r[l] += u);
                }
                for (var h = [], f = [], a = 0, p = e.length; a < p; a++)
                  if (0 !== r[a]) {
                    var y = e[a],
                      g = y.poly;
                    if (-1 === f.indexOf(g))
                      if (y.isExterior) h.push(g);
                      else {
                        -1 === f.indexOf(g) && f.push(g);
                        var v = h.indexOf(y.poly);
                        -1 !== v && h.splice(v, 1);
                      }
                  }
                ...
                switch (F.type) {
                  ...
                  case "intersection":
                    ...
                    t.length < e.length
                      ...
                      (this._isInResult = o === F.numMultiPolys && i < o);
                    break;
                  case "xor":
                  ...
                  case "difference":
                    ...
                    this._isInResult = u(t) !== u(e);
                    break;
                  default:
                    throw new Error(
                      "Unrecognized operation type found ".concat(F.type)
                    );
                }
          ...
          [
            {
              ...
              value: function (t, r, n) {
                ...
                return new e(new P(i, !0), new P(o, !1), [n], [s]);
              },
            },
          ]
        ),
    ...
    A = (function () {
      function e(r, n, i) {
        ...
        var o = d.round(r[0][0], r[0][1]);
        this.bbox = { ll: { x: o.x, y: o.y }, ur: { x: o.x, y: o.y } };
        for (var s = o, u = 1, l = r.length; u < l; u++) {
          if ("number" != typeof r[u][0] || "number" != typeof r[u][1])
            throw new Error(
              "Input geometry is not a valid Polygon or MultiPolygon"
            );
          var h = d.round(r[u][0], r[u][1]);
          (h.x === s.x && h.y === s.y) ||
            (this.segments.push(O.fromRing(s, h, this)),
    ...
    L = (function () {
      function e(r, n) {
        ...
        (this.exteriorRing = new A(r[0], this, !0)),
          (this.bbox = {
            ll: {
        ...
        for (var i = 1, o = r.length; i < o; i++) {
          var s = new A(r[i], this, !1);
          s.bbox.ll.x < this.bbox.ll.x && (this.bbox.ll.x = s.bbox.ll.x),
            s.bbox.ll.y < this.bbox.ll.y && (this.bbox.ll.y = s.bbox.ll.y),
            s.bbox.ur.x > this.bbox.ur.x && (this.bbox.ur.x = s.bbox.ur.x),
            s.bbox.ur.y > this.bbox.ur.y && (this.bbox.ur.y = s.bbox.ur.y),
        ...
        r(e, [
          {
            ...
            value: function () {
              for (var t = [], e = 0, r = this.polys.length; e < r; e++)
                for (
                  var n = this.polys[e].getSweepEvents(), i = 0, o = n.length;
                  i < o;
                  i++
                )
                  t.push(n[i]);
                ...
                if (o.isInResult() && !o.ringOut) {
                  for (
                    ...
                    for (;;) {
                      ...
                      for (var v = null, c = 0, x = a.length; c < x; c++)
                        if (a[c].point === u.point) {
                          v = c;
                          break;
                        }
                      if (null === v) {
                        a.push({ index: h.length, point: u.point });
                      ...
                      var m = a.splice(v)[0],
                        d = h.splice(m.index);
                      d.unshift(d[0].otherSE), r.push(new e(d.reverse()));
                    }
                  r.push(new e(h));
                }
              }
          ...
          },
          {
            ...
            value: function (t) {
              for (var e = [], r = 0, n = t.length; r < n; r++) {
                var i = t[r];
                if (!i.poly)
                  if (i.isExteriorRing()) e.push(new M(i));
                  else {
                    var o = i.enclosingRing();
                    o.poly || e.push(new M(o)), o.poly.addInterior(i);
                  }
              }
              return e;
            },
        ...
        r(e, [
          {
            ...
            value: function (t) {
              ...
              if (t.consumedBy)
                return (
                  t.isLeft ? this.queue.remove(t.otherSE) : this.tree.remove(e),
                  r
                );
              ...
              for (var i = n, o = n, s = void 0, u = void 0; void 0 === s; )
              ...
              for (; void 0 === u; )
                null === (o = this.tree.next(o))
                  ? (u = null)
                  : void 0 === o.key.consumedBy && (u = o.key);
              if (t.isLeft) {
                var l = null;
                if (s) {
                  var h = s.getIntersection(e);
                  if (
                    null !== h &&
                    (e.isAnEndpoint(h) || (l = h), !s.isAnEndpoint(h))
                  )
                    for (
                      var f = this._splitSafely(s, h), a = 0, p = f.length;
                      a < p;
                      a++
                    )
                      r.push(f[a]);
                ...
                var y = null;
                if (u) {
                  var g = u.getIntersection(e);
                  if (
                    null !== g &&
                    (e.isAnEndpoint(g) || (y = g), !u.isAnEndpoint(g))
                  )
                    for (
                      var v = this._splitSafely(u, g), c = 0, x = v.length;
                      c < x;
                      c++
                    )
                      r.push(v[c]);
                ...
                if (null !== l || null !== y) {
                  ...
                  if (null === l) b = y;
                    ...
                    b = P.comparePoints(l, y) <= 0 ? l : y;
                  }
                  this.queue.remove(e.rightSE), r.push(e.rightSE);
                  for (var m = e.split(b), d = 0, E = m.length; d < E; d++)
                    r.push(m[d]);
                }
                r.length > 0
                ...
                if (s && u) {
                  var S = s.getIntersection(u);
                  if (null !== S) {
                    if (!s.isAnEndpoint(S))
                      for (
                        var _ = this._splitSafely(s, S), k = 0, w = _.length;
                        k < w;
                        k++
                      )
                        r.push(_[k]);
                    if (!u.isAnEndpoint(S))
                      for (
                        var R = this._splitSafely(u, S), I = 0, N = R.length;
                        I < N;
                        I++
                      )
                        r.push(R[I]);
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              var n = t.split(e);
              return (
                n.push(r), void 0 === t.consumedBy && this.tree.insert(t), n
              );
            },
          },
        ]),
        ...
        r(e, [
          {
            ...
            value: function (t, e, r) {
              (F.type = t), d.reset();
              for (var n = [new z(e, !0)], i = 0, o = r.length; i < o; i++)
                n.push(new z(r[i], !1));
              if (((F.numMultiPolys = n.length), "difference" === F.type))
                for (var s = n[0], u = 1; u < n.length; )
                  null !== g(n[u].bbox, s.bbox) ? u++ : n.splice(u, 1);
              if ("intersection" === F.type)
                for (var l = 0, f = n.length; l < f; l++)
                  for (var a = n[l], p = l + 1, y = n.length; p < y; p++)
                    if (null === g(a.bbox, n[p].bbox)) return [];
              for (var v = new h(P.compare), c = 0, x = n.length; c < x; c++)
                for (
                  var b = n[c].getSweepEvents(), m = 0, E = b.length;
                  m < E;
                  m++
                )
                  if ((v.insert(b[m]), v.size > C))
                    throw new Error(
                      "Infinite loop when putting segment endpoints in a priority queue (queue size too big). Please file a bug report."
                    );
              for (var S = new T(v), _ = v.size, k = v.pop(); k; ) {
                var w = k.key;
                if (v.size === _) {
                  var R = w.segment;
                  throw new Error(
                    "Unable to pop() ".concat(
                      ...
                      "["
                        ...
                        .concat(R.rightSE.point.y, "] from queue. ") +
                ...
                if (S.segments.length > q)
                  throw new Error(
                    "Infinite loop when passing sweep line over endpoints (too many sweep line segments). Please file a bug report."
                  );
                for (var I = S.process(w), N = 0, O = I.length; N < O; N++) {
                  var A = I[N];
                  void 0 === A.consumedBy && v.insert(A);
                }
                (_ = v.size), (k = v.pop());
              }
              d.reset();
              var L = B.factory(S.segments);
              return new G(L).getGeom();
            },
          },
        ]),
        e
